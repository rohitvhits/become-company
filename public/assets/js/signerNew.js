   ...
   if (field.type == "image") {   
     ...
     if(docusignId ==field.signer_id){
         ...
         if(field.required == "true"){
             ...
             $('<div class="signer-element '+field.bold+'" id="'+field.id+'" type="checkbox"  group="input"   page="'+field.page+'"  style="position:absolute;display:none;left:'+xPos+'px;top:'+yPos+'px;"><input onclick="getChange('+checkboxid+');'+HideShowNew+'" style="outline: 1px solid #c00;" type="checkbox" class="checkbox_wrapper" contenteditable="true" style="" name="'+field.name+'"  value="'+field.checked+'" '+checked+' id="'+field.bold+'" '+readonly+' '+disabled+'></div>').appendTo(".signer-builder");
         }else{
             $('<div class="signer-element '+field.bold+'" id="'+field.id+'" type="checkbox"  group="input"   page="'+field.page+'"  style="position:absolute;display:none;left:'+xPos+'px;top:'+yPos+'px;"><input  onclick="getChange('+checkboxid+');'+HideShowNew+'" style="outline: 1px solid #c00;" type="checkbox" class="checkbox_wrapper" contenteditable="true" style="" name="'+field.name+'"  value="'+field.checked+'" '+checked+' id="'+field.bold+'" '+readonly+' '+disabled+' ></div>').appendTo(".signer-builder");
         }
     ...
     if(docusignId ==field.signer_id){
         ...
         $('<div class="signer-element '+field.groupNames+'" id="'+field.id+'" type="radio" groupName="'+field.groupNames+'" group="input"   page="'+field.page+'"  style="'+bgrequired+';position:absolute;display:none;left:'+xPos+'px;top:'+yPos+'px;"><input onchange="getChange('+checkboxid+')" '+checked+' '+disabled+' type="radio" id = "'+field.bold+'" class="radio_wrap"  value="'+field.checked+'" '+HideShow+' name="'+field.name+'" '+readonly+' ></div>').appendTo(".signer-builder");
         $.each(tempHeaderForHide[0],function(i,kes){ 
