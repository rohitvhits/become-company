...
function initEditor(){ 
    ! function(a) {
        a(document).ready(function() {
            ...
            var hexColor = $(".signer-tool[tool=color]").attr("color");
            var selectedColor = hexColor.replace("#", "");
            var i, l = {
                    $canvas: a("#document-viewer"),
                    color: selectedColor,
                    press: !1,
                    last: new Image,
                    hist: [],
            ...
            modules.erase = function() {
                    s(modules.original);
                }, l.$canvas.brushTool(l), modules.color(l.color);
            l.stroke = parseInt($(".font-size").val()), modules.stroke = function updateStroke(width) {
                    l.stroke = width
                },
                function() {
