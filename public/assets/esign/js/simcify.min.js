...
function _toConsumableArray(e) {
    ...
    return function() {
        function t(t, i) {
            return t || (t = s()), (a = e("#" + t.containerId)).length ? a : (i && (n = t, (a = e("<div/>").attr("id", n.containerId).addClass(n.positionClass)).appendTo(e(n.target)), a = a), a);
            var n
        }
        ...
        function r(i) {
            ...
            function l(t) {
                var i = t && !1 !== d.closeMethod ? d.closeMethod : d.hideMethod,
                    r = t && !1 !== d.closeDuration ? d.closeDuration : d.hideDuration,
                    s = t && !1 !== d.closeEasing ? d.closeEasing : d.hideEasing;
            ...
            if (void 0 !== i.optionsOverride && (d = e.extend(d, i.optionsOverride), h = i.optionsOverride.iconClass || h), ! function(e, t) {
                ...
                return i.iconClass && f.addClass(d.toastClass).addClass(h),
                    function() {
                        if (i.title) {
                            var e = i.title;
                            d.escapeHtml && (e = r(i.title)), m.append(e).addClass(d.titleClass), f.append(m)
                        }
                    }(),
                    function() {
                        if (i.message) {
                            var e = i.message;
                            d.escapeHtml && (e = r(i.message)), v.append(e).addClass(d.messageClass), f.append(v)
                        }
                    }(), d.closeButton && (y.addClass(d.closeClass).attr("role", "button"), f.prepend(y)), d.progressBar && (g.addClass(d.progressClass), f.prepend(g)), d.rtl && f.addClass("rtl"), d.newestOnTop ? a.prepend(f) : a.append(f),
                    function() {
                        var e = "";
                        switch (i.iconClass) {
                            case "toast-success":
        ...
        function o(e) {
            a || (a = t()), e.is(":visible") || (e.remove(), e = null, 0 === a.children().length && (a.remove(), u = void 0))
        }
        var a, l, u, c = 0,
            d = "error",
            h = "info",
            ...
            m = {
                clear: function(n, r) {
                    var o = s();
                    a || t(o), i(n, o, r) || function(t) {
                        for (var n = a.children(), r = n.length - 1; r >= 0; r--) i(e(n[r]), t)
                    }(o)
                },
                remove: function(i) {
                    var n = s();
...
function() {
    ...
    e.loader = "component", e.helper = {}, e.helper.semVerSort = function(e, t) {
        for (var i = e.version.split("."), n = t.version.split("."), r = 0; r < i.length; ++r) {
            var s = parseInt(i[r], 10),
                o = parseInt(n[r], 10);
            if (s !== o) return s > o ? 1 : -1;
            var a = i[r].substr(("" + s).length),
                l = n[r].substr(("" + o).length);
            if ("" === a && "" !== l) return 1;
            if ("" !== a && "" === l) return -1;
        ...
        var r = /(.*)~(.*)@v?(\d+\.\d+\.\d+[^\/]*)$/;
        /(.*)~(.*)/.test(t) || n(t);
        for (var s = Object.keys(e.modules), o = [], a = [], l = 0; l < s.length; l++) {
            var u = s[l];
            if (new RegExp(t + "@").test(u)) {
                var c = u.substr(t.length + 1);
                null != r.exec(u) ? o.push({
                    version: c,
                    name: u
                }) : a.push({
                    version: c,
        ...
        function i(e) {
            ...
            this.onClick = function() {
                ...
                "click" === t ? r.call(e, t, i.hijacked || (i.hijacked = function(e) {
        ...
        i.prototype.deviceIsAndroid = navigator.userAgent.indexOf("Android") > 0, i.prototype.deviceIsIOS = /iP(ad|hone|od)/.test(navigator.userAgent), i.prototype.deviceIsIOS4 = i.prototype.deviceIsIOS && /OS 4_\d(_\d)?/.test(navigator.userAgent), i.prototype.deviceIsIOSWithBadTarget = i.prototype.deviceIsIOS && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent), i.prototype.needsClick = function(e) {
            ...
            "use strict";
            var t, i, n, r, s, o = this.targetElement;
            ...
            return !(!this.deviceIsIOS || this.deviceIsIOS4 || !(r = o.fastClickScrollParent) || r.fastClickLastScrollTop === r.scrollTop) || (this.needsClick(o) || (e.preventDefault(), this.sendClick(o, e)), !1)
        ...
        t.bind = function(e, t, i, s, o) {
            return r.bind(e, i, function(i) {
        ...
        i.exports = s, s.prototype.sub = function(e, t, i) {
            ...
            return s.selector ? c = r.bind(o, s.selector, l, c) : n.bind(o, l, c), this.sub(l, t, c), c
        ...
        l.prototype.hide = function() {
            ...
            var e = this.switcher;
            r(e), this.events.bind("click", "bindClick")
...
function(e, t, i) {
    ...
    ! function e(t, i, n) {
        ...
        1: [function(n, r, s) {
            ...
            var a, l, u, c, d = n("./modules/handle-dom"),
                h = n("./modules/utils"),
                p = n("./modules/handle-swal-dom"),
                f = n("./modules/handle-click"),
                m = o(n("./modules/handle-key")),
                v = o(n("./modules/default-params")),
                g = o(n("./modules/set-params"));
            s.default = u = c = function() {
                function n(e) {
                    var t = r;
                    return t[e] === i ? v.default[e] : t[e]
                }
                var r = arguments[0];
                if ((0, d.addClass)(t.body, "stop-scrolling"), (0, p.resetInput)(), r === i) return (0, h.logStr)("SweetAlert expects at least 1 attribute!"), !1;
                var s = (0, h.extend)({}, v.default);
                switch (typeof r) {
                    case "string":
                        s.title = r, s.text = arguments[1] || "", s.type = arguments[2] || "";
                        break;
                    case "object":
                        if (r.title === i) return (0, h.logStr)('Missing "title" argument!'), !1;
                        s.title = r.title;
                        for (var o in v.default) s[o] = n(o);
                        s.confirmButtonText = s.showCancelButton ? "Confirm" : v.default.confirmButtonText, s.confirmButtonText = n("confirmButtonText"), s.doneFunction = arguments[1] || null;
                        break;
                    default:
                        return (0, h.logStr)('Unexpected type of argument! Expected "string" or "object", got ' + typeof r), !1
                }(0, g.default)(s), (0, p.fixVerticalPosition)(), (0, p.openModal)(arguments[1]);
                for (var u = (0, p.getModal)(), y = u.querySelectorAll("button"), w = ["onclick", "onmouseover", "onmouseout", "onmousedown", "onmouseup", "onfocus"], b = function(e) {
                        return (0, f.handleButton)(e, s, u)
                    }, C = 0; C < y.length; C++)
                    for (var x = 0; x < w.length; x++) {
                        var E = w[x];
                        y[C][E] = b
                    }(0, p.getOverlay)().onclick = b, a = e.onkeydown, e.onkeydown = function(e) {
                        return (0, m.default)(e, s, u)
                    }, e.onfocus = function() {
                        setTimeout(function() {
                            l !== i && (l.focus(), l = i)
                        }, 0)
                ...
                (0, d.removeClass)(r, "animate"), (0, d.removeClass)(r.querySelector(".sa-tip"), "animateSuccessTip"), (0, d.removeClass)(r.querySelector(".sa-long"), "animateSuccessLong");
            ...
            }, void 0 !== e ? e.sweetAlert = e.swal = u : (0, h.logStr)("SweetAlert is a frontend module!"), r.exports = s.default
        }, {
            ...
            n.default = {
                handleButton: function(t, i, n) {
                    ...
                    var u, c, d, h = t || e.event,
                        ...
                        v = (0, s.hasClass)(n, "visible"),
                        g = i.doneFunction && "true" === n.getAttribute("data-has-done-function");
                    switch (f && i.confirmButtonColor && (u = i.confirmButtonColor, c = (0, r.colorLuminance)(u, -.04), d = (0, r.colorLuminance)(u, -.14)), h.type) {
                        case "mouseover":
                            l(c);
                            break;
                        case "mouseout":
                        ...
                        case "click":
                            var b = n === p,
                                C = (0, s.isDescendant)(n, p);
                            if (!b && !C && v && !i.allowOutsideClick) break;
                            f && g && v ? o(n, i) : g && v || m ? a(0, i) : (0, s.isDescendant)(n, p) && "BUTTON" === p.tagName && sweetAlert.close()
                    }
                },
                handleConfirm: o,
                handleCancel: a
        ...
        4: [function(i, n, r) {
            ...
            r.hasClass = s, r.addClass = function(e, t) {
                s(e, t) || (e.className += " " + t)
            ...
            }, r._show = o, r.show = function(e) {
                if (e && !e.length) return o(e);
                for (var t = 0; t < e.length; ++t) o(e[t])
            }, r._hide = a, r.hide = function(e) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(l)) {
                    for (var h = a.target || a.srcElement, p = -1, f = 0; f < d.length; f++)
                        if (h === d[f]) {
                            p = f;
                            break
                        } 9 === l ? (h = -1 === p ? u : p === d.length - 1 ? d[0] : d[p + 1], (0, s.stopEventPropagation)(a), h.focus(), n.confirmButtonColor && (0, o.setFocusStyle)(h, n.confirmButtonColor)) : 13 === l ? ("INPUT" === h.tagName && (h = u, u.focus()), h = -1 === p ? u : i) : 27 === l && !0 === n.allowEscapeKey ? (h = c, (0, s.fireClick)(h, a)) : h = i
                }
            }, n.exports = r.default
        }, {
            "./handle-dom": 4,
        ...
        6: [function(i, n, r) {
            ...
            r.sweetAlertInitialize = c, r.getModal = d, r.getOverlay = p, r.getInput = h, r.setFocusStyle = function(e, t) {
                var i = (0, o.hexToRgb)(t);
                e.style.boxShadow = "0 0 2px rgba(" + i + ", 0.8), inset 0 0 0 1px rgba(0, 0, 0, 0.05)"
            }, r.openModal = function(i) {
                var n = d();
                ...
                if ("null" !== r && "" !== r) {
                    ...
                    n.timeout = setTimeout(function() {
                        s && "true" === n.getAttribute("data-has-done-function") ? s(null) : sweetAlert.close()
                    }, r)
                }
            ...
            }, r.resetInputError = f, r.fixVerticalPosition = function() {
        ...
        8: [function(e, t, n) {
            ...
            n.default = function(e) {
                ...
                if ((0, o.hide)(t.querySelectorAll(".sa-icon")), e.type && !(0, r.isIE8)()) {
                    var h = function() {
                        ...
                        switch (e.type) {
                            ...
                            case "input":
                            case "prompt":
                                u.setAttribute("type", e.inputType), u.value = e.inputValue, u.setAttribute("placeholder", e.inputPlaceholder), (0, o.addClass)(t, "show-input"), setTimeout(function() {
        ...
        9: [function(t, i, n) {
            Object.defineProperty(n, "__esModule", {
                ...
                var i, n, r = "#";
                for (n = 0; 3 > n; n++) i = parseInt(e.substr(2 * n, 2), 16), i = Math.round(Math.min(Math.max(0, i + i * t), 255)).toString(16), r += ("00" + i).substr(i.length);
                return r
            }
        }, {}]
...
function(e, t) {
    ...
    return i.prototype.onChange = function() {
        ...
        if (t.files && t.files[0]) {
            ...
            this.clearErrors(), this.showLoader(), this.setFileInformations(r), i.readAsDataURL(r), this.errorsEvent.errors = [], this.checkFileSize(), i.onload = function(e) {
                s = e.target.result, this.isImage() ? (n.src = e.target.result, n.onload = function() {
                    o.setFileDimensions(this.width, this.height), o.validateImage(), o.input.trigger(a, [s])
                }) : this.input.trigger(a, [s])
...
function(e, t) {
    ...
    "function" != typeof Promise && function(e) {
        ...
        function i(e) {
            ...
            this._state = null, this._value = null, this._deferreds = [], a(e, t(r, this), t(s, this))
        }
        ...
        function r(e) {
            try {
                ...
                if (e && ("object" == typeof e || "function" == typeof e)) {
                    var i = e.then;
                    if ("function" == typeof i) return void a(t(i, e), t(r, this), t(s, this))
                }
        ...
        value: function(e, t, i) {
            for (var n = atob(this.toDataURL(t, i).split(",")[1]), r = n.length, s = new Uint8Array(r), o = 0; o < r; o++) s[o] = n.charCodeAt(o);
            e(new Blob([s], {
                type: t || "image/png"
            }))
        }
    });
    var t, i, n, r = ["Webkit", "Moz", "ms"],
    ...
    function l(e) {
        if (e in s) return e;
        for (var t = e[0].toUpperCase() + e.slice(1), i = r.length; i--;)
            if ((e = r[i] + t) in s) return e
    }

    function u(e, t) {
        e = e || {};
        for (var i in t) t[i] && t[i].constructor && t[i].constructor === Object ? (e[i] = e[i] || {}, u(e[i], t[i])) : e[i] = t[i];
        return e
    }
    ...
    y.parse = function(e) {
        ...
        var t = e.split(") "),
            i = t[0].substring(N.globals.translate.length + 1).split(","),
            n = t.length > 1 ? t[1].substring(6) : 1,
            r = i.length > 1 ? i[0] : 0,
            s = i.length > 1 ? i[1] : 0;
        return new y(r, s, n)
    }, y.prototype.toString = function() {
        var e = g[N.globals.translate].suffix || "";
        return N.globals.translate + "(" + this.x + "px, " + this.y + "px" + e + ") scale(" + this.scale + ")"
    };
    var w = function(e) {
    ...
    function C(e, t, i) {
        var n = t.width,
            r = t.height,
            s = e.getContext("2d");
        switch (e.width = t.width, e.height = t.height, s.save(), i) {
            case 2:
                s.translate(n, 0), s.scale(-1, 1);
                break;
            case 3:
                s.translate(n, r), s.rotate(180 * Math.PI / 180);
                break;
            case 4:
                s.translate(0, r), s.scale(1, -1);
                break;
            case 5:
                e.width = r, e.height = n, s.rotate(90 * Math.PI / 180), s.scale(1, -1);
                break;
            case 6:
                e.width = r, e.height = n, s.rotate(90 * Math.PI / 180), s.translate(0, -r);
                break;
            case 7:
                e.width = r, e.height = n, s.rotate(-90 * Math.PI / 180), s.translate(-n, r), s.scale(1, -1);
                break;
            case 8:
                e.width = r, e.height = n, s.translate(0, n), s.rotate(-90 * Math.PI / 180)
        }
        s.drawImage(t, 0, 0, n, r), s.restore()
    }
    ...
    function F(e) {
        var n = this,
            r = e ? e.transform : y.parse(n.elements.preview),
            s = e ? e.viewportRect : n.elements.viewport.getBoundingClientRect(),
            o = e ? e.origin : new w(n.elements.preview);

        function a() {
            var e = {};
            e[i] = r.toString(), e[t] = o.toString(), h(n.elements.preview, e)
        }
        if (n._currentZoom = e ? e.value : n._currentZoom, r.scale = n._currentZoom, n.elements.zoomer.setAttribute("aria-valuenow", n._currentZoom), a(), n.options.enforceBoundary) {
            var l = function(e) {
                    var t = this._currentZoom,
                        i = e.width,
                        n = e.height,
                        r = this.elements.boundary.clientWidth / 2,
                        s = this.elements.boundary.clientHeight / 2,
                ...
                u = l.translate,
                c = l.origin;
            r.x >= u.maxX && (o.x = c.minX, r.x = u.maxX), r.x <= u.minX && (o.x = c.maxX, r.x = u.minX), r.y >= u.maxY && (o.y = c.minY, r.y = u.maxY), r.y <= u.minY && (o.y = c.maxY, r.y = u.minY)
        }
        a(), T.call(n), I.call(n)
    }
    ...
    function k() {
        var e = this,
            ...
            s = e.elements.viewport.getBoundingClientRect(),
            o = y.parse(e.elements.preview.style[i]),
            a = new w(e.elements.preview),
            l = s.top - r.top + s.height / 2,
            u = s.left - r.left + s.width / 2,
            c = {},
            d = {};
        c.y = l / n, c.x = u / n, d.y = (c.y - a.y) * (1 - n), d.x = (c.x - a.x) * (1 - n), o.x -= d.x, o.y -= d.y;
        var p = {};
        p[t] = c.x + "px " + c.y + "px", p[i] = o.toString(), h(e.elements.preview, p)
    }
    ...
    function M() {
        var e, n = this,
            ...
            o = new y(0, 0, 1),
            a = new w;
        O.call(n) && !n.data.bound && (n.data.bound = !0, r[i] = o.toString(), r[t] = a.toString(), r.opacity = 1, h(s, r), e = n.elements.preview.getBoundingClientRect(), n._originalImageWidth = e.width, n._originalImageHeight = e.height, n.data.orientation = b(n.elements.img), n.options.enableZoom ? P.call(n, !0) : n._currentZoom = 1, o.scale = n._currentZoom, r[i] = o.toString(), h(s, r), n.data.points.length ? function(e) {
            if (4 !== e.length) throw "Croppie - Invalid number of points supplied: " + e;
            var n = this,
                r = e[2] - e[0],
                s = n.elements.viewport.getBoundingClientRect(),
                ...
                f = -1 * e[0] + a,
                m = {};
            m[t] = d + "px " + c + "px", m[i] = new y(f, p, u).toString(), h(n.elements.preview, m), E.call(n, u), n._currentZoom = u
        }.call(n, n.data.points) : function() {
            var e = this,
                t = e.elements.preview.getBoundingClientRect(),
                n = e.elements.viewport.getBoundingClientRect(),
                r = e.elements.boundary.getBoundingClientRect(),
                s = n.left - r.left,
                o = n.top - r.top,
                a = s - (t.width - n.width) / 2,
                l = o - (t.height - n.height) / 2,
                u = new y(a, l, e._currentZoom);
            h(e.elements.preview, i, u.toString())
        }.call(n), k.call(n), A.call(n))
    }

    function P(e) {
        var t, i, n, r, s = this,
            o = 0,
            a = s.options.maxZoom || 1.5,
            l = s.elements.zoomer,
            u = parseFloat(l.value),
            c = s.elements.boundary.getBoundingClientRect(),
            h = v(s.elements.img, s.data.orientation),
            p = s.elements.viewport.getBoundingClientRect();
        s.options.enforceBoundary && (n = p.width / h.width, r = p.height / h.height, o = Math.max(n, r)), o >= a && (a = o + 1), l.min = j(o, 4), l.max = j(a, 4), !e && (u < l.min || u > l.max) ? E.call(s, u < l.min ? l.min : l.max) : e && (i = Math.max(c.width / h.width, c.height / h.height), t = null !== s.data.boundZoom ? s.data.boundZoom : i, E.call(s, t)), d(l)
    }
    ...
    function B(e, t) {
        ...
        if ("string" == typeof e) i = e, e = {};
            ...
            if (void 0 === e && o.data.url) return M.call(o), I.call(o), null;
            i = e.url, a = e.points || [], l = void 0 === e.zoom ? null : e.zoom
        }
        return o.data.bound = !1, o.data.url = i || o.data.url, o.data.boundZoom = l, (n = i, r = u, s = new Image, s.style.opacity = 0, new Promise(function(e) {
            function t() {
                s.style.opacity = 1, setTimeout(function() {
                    e(s)
                }, 1)
            }
            s.removeAttribute("crossOrigin"), n.match(/^https?:\/\/|^\/\//) && s.setAttribute("crossOrigin", "anonymous"), s.onload = function() {
                r ? EXIF.getData(s, function() {
                    t()
                }) : t()
            }, s.src = n
        })).then(function(i) {
            if (function(e) {
                ...
                var n, r, s = v(i),
                    ...
                    u = l.width / l.height;
                s.width / s.height > u ? n = (r = s.height) * u : (n = s.width, r = s.height / u);
                var c = (s.width - n) / 2,
                    d = (s.height - r) / 2,
                    h = c + n,
                    p = d + r;
                o.data.points = [c, d, h, p]
            }
            o.data.points = a.map(function(e) {
                ...
                var t = this.elements.canvas,
                    ...
                    n = t.getContext("2d"),
                    r = x.call(this);
                e = this.options.enableOrientation && e, n.clearRect(0, 0, t.width, t.height), t.width = i.width, t.height = i.height, r && !e ? C(t, i, m(b(i) || 0)) : e && C(t, i, e)
            }.call(o, e.orientation || 1), M.call(o), I.call(o), t && t()
        }).catch(function(e) {
    ...
    function z() {
        var e = this,
            ...
            a = n + e.elements.viewport.offsetWidth + s,
            l = r + e.elements.viewport.offsetHeight + o,
            u = e._currentZoom;
        (u === 1 / 0 || isNaN(u)) && (u = 1);
        var c = e.options.enforceBoundary ? 0 : Number.NEGATIVE_INFINITY;
        return n = Math.max(c, n / u), r = Math.max(c, r / u), a = Math.max(c, a / u), l = Math.max(c, l / u), {
            points: [j(n), j(r), j(a), j(l)],
            zoom: u,
        ...
        q.fn.croppie = function(e) {
            if ("string" == typeof e) {
                ...
                return "get" === e ? i.get() : "result" === e ? i.result.apply(i, t) : "bind" === e ? i.bind.apply(i, t) : this.each(function() {
                    var i = q(this).data("croppie");
                    if (i) {
                        var n = i[e];
                        if (!q.isFunction(n)) throw "Croppie " + e + " method not found";
                        n.apply(i, t), "destroy" === e && q(this).removeData("croppie")
                    }
                })
            }
            return this.each(function() {
    ...
    function N(e, t) {
        ...
        if (this.element = e, this.options = u(c(N.defaults), t), "img" === this.element.tagName.toLowerCase()) {
            var r = this.element;
            p(r, "cr-original-image"), f(r, {
                "aria-hidden": "true",
                alt: ""
            });
            var s = document.createElement("div");
            this.element.parentNode.appendChild(s), s.appendChild(r), this.element = s, this.options.url = this.options.url || r.src
        }
        if (function() {
                var e, t, r, s, o, a = this,
                    l = a.options.viewport.type ? "cr-vp-" + a.options.viewport.type : null;
                a.options.useCanvas = a.options.enableOrientation || x.call(a), a.data = {}, a.elements = {}, e = a.elements.boundary = document.createElement("div"), t = a.elements.viewport = document.createElement("div"), a.elements.img = document.createElement("img"), r = a.elements.overlay = document.createElement("div"), a.options.useCanvas ? (a.elements.canvas = document.createElement("canvas"), a.elements.preview = a.elements.canvas) : a.elements.preview = a.elements.img, p(e, "cr-boundary"), e.setAttribute("aria-dropeffect", "none"), s = a.options.boundary.width, o = a.options.boundary.height, h(e, {
                        width: s + (isNaN(s) ? "" : "px"),
                        height: o + (isNaN(o) ? "" : "px")
                        ...
                        alt: "preview",
                        "aria-grabbed": "false"
                    }), p(r, "cr-overlay"), a.element.appendChild(e), e.appendChild(a.elements.preview), e.appendChild(t), e.appendChild(r), p(a.element, "croppie-container"), a.options.customClass && p(a.element, a.options.customClass),
                    function() {
                        var e, t, r, s, o, a = this,
                            l = !1;
                        ...
                        function u(e, t) {
                            var i = a.elements.preview.getBoundingClientRect(),
                                n = o.y + t,
                                r = o.x + e;
                            a.options.enforceBoundary ? (s.top > i.top + t && s.bottom < i.bottom + t && (o.y = n), s.left > i.left + e && s.right < i.right + e && (o.x = r)) : (o.y = n, o.x = r)
                        }
                        ...
                        function p(i) {
                            if ((void 0 === i.button || 0 === i.button) && (i.preventDefault(), !l)) {
                                ...
                                c(l), o = y.parse(a.elements.preview), window.addEventListener("mousemove", f), window.addEventListener("touchmove", f), window.addEventListener("mouseup", m), window.addEventListener("touchend", m), document.body.style[n] = "none", s = a.elements.viewport.getBoundingClientRect()
                            }
                        }
                        ...
                        function f(n) {
                            ...
                            if ("touchmove" === n.type && n.touches.length > 1) {
                                ...
                                r || (r = y / a._currentZoom);
                                var w = y / r;
                                return E.call(a, w), void d(a.elements.zoomer)
                            }
                            u(p, f), m[i] = o.toString(), h(a.elements.preview, m), A.call(a), t = l, e = s
                        }

                        function m() {
                            c(l = !1), window.removeEventListener("mousemove", f), window.removeEventListener("touchmove", f), window.removeEventListener("mouseup", m), window.removeEventListener("touchend", m), document.body.style[n] = "", k.call(a), I.call(a), r = 0
                        }
                        a.elements.overlay.addEventListener("mousedown", p), a.elements.viewport.addEventListener("keydown", function(e) {
                            ...
                            if (!e.shiftKey || 38 !== e.keyCode && 40 !== e.keyCode) {
                                if (a.options.enableKeyMovement && e.keyCode >= 37 && e.keyCode <= 40) {
                                    ...
                                    o = y.parse(a.elements.preview), document.body.style[n] = "none", s = a.elements.viewport.getBoundingClientRect(), l = {}, u((t = d)[0], t[1]), l[i] = o.toString(), h(a.elements.preview, l), A.call(a), document.body.style[n] = "", k.call(a), I.call(a), r = 0
                                }
                            } else c = 38 === e.keyCode ? parseFloat(a.elements.zoomer.value, 10) + parseFloat(a.elements.zoomer.step, 10) : parseFloat(a.elements.zoomer.value, 10) - parseFloat(a.elements.zoomer.step, 10), a.setZoom(c)
                        ...
                        function r(t) {
                            ...
                            i = t.wheelDelta ? t.wheelDelta / 1200 : t.deltaY ? t.deltaY / 1060 : t.detail ? t.detail / -60 : 0, r = e._currentZoom + i * e._currentZoom, t.preventDefault(), E.call(e, r), n.call(e)
                        }
                        p(t, "cr-slider-wrap"), p(i, "cr-slider"), i.type = "range", i.step = "0.0001", i.value = 1, i.style.display = e.options.showZoomer ? "" : "none", i.setAttribute("aria-label", "zoom"), e.element.appendChild(t), t.appendChild(i), e._currentZoom = 1, e.elements.zoomer.addEventListener("input", n), e.elements.zoomer.addEventListener("change", n), e.options.mouseWheelZoom && (e.elements.boundary.addEventListener("mousewheel", r), e.elements.boundary.addEventListener("DOMMouseScroll", r))
                    }.call(a), a.options.enableResize && function() {
                        var e, t, i, r, s, o, a, l = this,
                            u = document.createElement("div"),
                            c = !1,
                            d = 50;

                        function f(o) {
                            if ((void 0 === o.button || 0 === o.button) && (o.preventDefault(), !c)) {
                                var a = l.elements.overlay.getBoundingClientRect();
                                if (c = !0, t = o.pageX, i = o.pageY, e = -1 !== o.currentTarget.className.indexOf("vertical") ? "v" : "h", r = a.width, s = a.height, o.touches) {
                                    var u = o.touches[0];
                                    t = u.pageX, i = u.pageY
                                }
                                window.addEventListener("mousemove", m), window.addEventListener("touchmove", m), window.addEventListener("mouseup", v), window.addEventListener("touchend", v), document.body.style[n] = "none"
                            }
                        }
                        ...
                        function m(n) {
                            ...
                            })), A.call(l), P.call(l), k.call(l), I.call(l), i = a, t = o
                        }

                        function v() {
                            c = !1, window.removeEventListener("mousemove", m), window.removeEventListener("touchmove", m), window.removeEventListener("mouseup", v), window.removeEventListener("touchend", v), document.body.style[n] = ""
                        }
                        p(u, "cr-resizer"), h(u, {
                            width: this.options.viewport.width + "px",
                            height: this.options.viewport.height + "px"
                        }), this.options.resizeControls.height && (p(o = document.createElement("div"), "cr-resizer-vertical"), u.appendChild(o)), this.options.resizeControls.width && (p(a = document.createElement("div"), "cr-resizer-horisontal"), u.appendChild(a)), o && (o.addEventListener("mousedown", f), o.addEventListener("touchstart", f)), a && (a.addEventListener("mousedown", f), a.addEventListener("touchstart", f)), this.elements.boundary.appendChild(u)
                    }.call(a)
            ...
            delete this.options.url, delete this.options.points, B.call(this, o)
        }
    }
    N.defaults = {
        viewport: {
        ...
        result: function(e) {
            return function(e) {
                var t = this,
                    i = z.call(t),
                    n = u(c(L), c(e)),
                    r = "string" == typeof e ? e : n.type || "base64",
                    s = n.size || "viewport",
                    o = n.format,
                    a = n.quality,
                    l = n.backgroundColor,
                    ...
                    m = f.width / f.height;
                return "viewport" === s ? (i.outputWidth = f.width, i.outputHeight = f.height) : "object" == typeof s && (s.width && s.height ? (i.outputWidth = s.width, i.outputHeight = s.height) : s.width ? (i.outputWidth = s.width, i.outputHeight = s.width / m) : s.height && (i.outputWidth = s.height * m, i.outputHeight = s.height)), R.indexOf(o) > -1 && (i.format = "image/" + o, i.quality = a), i.circle = d, i.url = t.data.url, i.backgroundColor = l, new Promise(function(e, n) {
                    switch (r.toLowerCase()) {
                        ...
                        case "base64":
                            e(function(e) {
                                return D.call(this, e).toDataURL(e.format, e.quality)
                            }.call(t, i));
                            break;
                        case "blob":
                            (function(e) {
        ...
        setZoom: function(e) {
            E.call(this, e), d(this.elements.zoomer)
        },
        rotate: function(e) {
            (function(e) {
                ...
                var t, i, n, r, s, l = this,
                    u = l.elements.canvas;
                l.data.orientation = (t = l.data.orientation, i = e, r = (n = o.indexOf(t) > -1 ? o : a).indexOf(t), s = i / 90 % n.length, n[(n.length + r + s % n.length) % n.length]), C(u, l.elements.img, l.data.orientation), P.call(l), F.call(l), copy = null
            }).call(this, e)
        },
        destroy: function() {
            return function() {
...
function readFile(e) {
    ...
    function t(e, t) {
        return e.parsleyAdaptedCallback || (e.parsleyAdaptedCallback = function() {
            ...
            i.unshift(this), e.apply(t || _, i)
        }), e.parsleyAdaptedCallback
    }

    function i(e) {
        return 0 === e.lastIndexOf(T, 0) ? e.substr(T.length) : e
    }
    var n, r = 1,
        s = {},
        o = {
            attr: function(e, t, i) {
                ...
                if (!e) return i;
                for (n = (s = e.attributes).length; n--;) r = s[n], r && r.specified && o.test(r.name) && (i[this.camelize(r.name.slice(t.length))] = this.deserializeValue(r.value));
                return i
            },
        ...
        trigger: function(e, t, i) {
            ...
            if (r)
                for (var s = r.length; s--;)
                    if (n = r[s].call(t, t, i), !1 === n) return n;
    ...
    var h = function(e) {
        ...
        p = function(e, t) {
            return function(i) {
                ...
                return r.pop(), t.apply(void 0, [i].concat(_toConsumableArray((a = e, r.map(o.parse[a])))));
                var a
            }
        },
        f = function(e) {
    ...
    w.prototype = {
        ...
        whenValid: function() {
            ...
            if (i._refreshed || this.refreshConstraints(), !a || this._isInGroup(a)) {
                ...
                if (void 0 !== s && null !== s || (s = this.getValue()), !this.needsValidation(s) && !0 !== r) return e.when();
    ...
    E.prototype = {
        ...
        handleMultiple: function() {
            ...
            for (var r = this._findRelated(), s = 0; s < r.length; s++)
                if (i = e(r.get(s)).data("Parsley"), void 0 !== i) {
        ...
        bind: function(t, i) {
            ...
            switch (t) {
                ...
                case "parsleyFieldMultiple":
                    n = e.extend(new C(this.element, this.domOptions, this.options, this.parent), new x, new l, window.ParsleyExtend)._init();
                    break;
                default:
    ...
    F.forEach || o.warn("Parsley requires ES5 to run properly. Please include https://github.com/es-shims/es5-shim");
    ...
    _extends(C.prototype, m.Field, l.prototype), _extends(v.prototype, m.Form, l.prototype), _extends(E.prototype, l.prototype), e.fn.parsley = e.fn.psly = function(t) {
        if (this.length > 1) {
            var i = [];
            return this.each(function() {
        ...
        return e(this).length ? new E(this[0], t) : void o.warn("You must bind Parsley on an existing element.")
    ...
    var A = window.Parsley._validatorRegistry = new c(window.ParsleyConfig.validators, window.ParsleyConfig.i18n);
    ...
    return e.listen = function(e, n) {
        var r;
        if (S(), "object" == typeof arguments[1] && "function" == typeof arguments[2] && (r = arguments[1], n = arguments[2]), "function" != typeof n) throw new Error("Wrong parameters");
        window.Parsley.on(i(e), t(n, r))
    }, e.listenTo = function(e, n, r) {
        if (S(), !(e instanceof C || e instanceof v)) throw new Error("Must give Parsley instance");
        ...
        S(), window.Parsley.off(i(t)), e("form,input,textarea,select").each(function() {
        ...
        var n;
        S();
        var r = t instanceof C || t instanceof v,
        ...
        validateString: function(t, i, n, r) {
            ...
            (i = k.asyncValidators[l].url || i).indexOf("{value}") > -1 ? i = i.replace("{value}", encodeURIComponent(t)) : a[r.element.getAttribute("name") || r.element.getAttribute("id")] = t;
            var u = e.extend(!0, n.options || {}, k.asyncValidators[l].options);
            s = e.extend(!0, {}, {
                url: i,
                data: a,
                type: "GET"
            }, u), r.trigger("field:ajaxoptions", r, s), o = e.param(s), void 0 === k._remoteCache && (k._remoteCache = {});
            var c = k._remoteCache[o] = k._remoteCache[o] || e.ajax(s),
                d = function() {
                    var t = k.asyncValidators[l].fn.call(r, c, i, n);
    ...
    toastr.options = {
        ...
        hideMethod: "slideUp"
    }, $(".dropify") && $(".dropify").dropify(), $(".croppie") && croppify(), Array.prototype.slice.call(document.querySelectorAll(".switch")).forEach(function(e) {
        new Switchery(e, {
            size: "small",
            color: "#007bff"
        })
    ...
    if (s.forEach(function(e) {
            var t = e.split(":");
            i[t[0]] = t[1]
        }), "true" === t.attr("loader") ? r = !0 : "false" === t.attr("loader") && (r = !1), void 0 === t.attr("warning-title")) server({
        url: n,
        data: i,
        loader: r
    });
    ...
    var t = $(this),
        ...
        o = (n = t.attr("url"), !0),
        a = {};
    (a[r] = s, void 0 !== t.attr("extradata")) && i.split("|").forEach(function(e) {
        var t = e.split(":");
        a[t[0]] = t[1]
    });
    ...
    "true" === t.attr("loader") ? s = !0 : "false" === t.attr("loader") && (s = !1), s && (showLoader(), $(r).html('<div class="loader-box"><div class="circle-loader"></div></div>')), $.post(n, i).done(function(e) {
        s && hideLoader(), void 0 !== t.attr("modal") && $(t.attr("modal")).modal({
            show: !0,
            backdrop: "static",
            keyboard: !1
        }), $(r).html(e)
