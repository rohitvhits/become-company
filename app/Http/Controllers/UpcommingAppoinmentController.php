...
class UpcommingAppoinmentController extends BaseController
{
    ...
    {
        $this->middleware('permission:appointments-upcomming', ['only' => ['index']]);
    ...
    public function index()
    {
        ...
        $data['listHeadingName'] = "Upcoming Appointments";
        $data['appointmentUrl'] = "upcomming-appoinment";
        ...
        $open_record_list = $this->PatientService->UpcommingAppoinmentSearch("", $full_name, "", $mobile, $status, "", $appointment_date, $agency_fk, $location_id, $service_id, $type, $created_date, $sms_status, $record_form, $due_date, $assign_user_id);
        ...
        return view('UpcommingAppointment.upcomming_appoinment_list', $data);
    }
    ...
    public function ajaxList(Request $request)
    {
        ...
        $open_record_list = $this->PatientService->UpcommingAppoinmentSearch($agency_name, $doctor_id, $type, $full_name, $phone_no, $dob, $locationId, $appoinment_date, $datepickernn, $service_id);
        ...
        $data['open_record_list'] = $open_record_list;
        return view('UpcommingAppointment.upcomming_appoinment_ajax_list', $data);
    }
}
