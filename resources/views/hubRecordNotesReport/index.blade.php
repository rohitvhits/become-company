...
<link href="{{ asset('assets/modulejs/css/hub_record/hub_record_report.css')}}" rel="stylesheet" type="text/css" />
...
<div class="main-panel main-page-box">
    ...
    <div class="content-wrapper content-wrapper-box">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Hub Notes Report</h5>
                            ...
                            <form id="search-form">
                                 ...
                                 <div class="col-md-3">
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-12">
                                             <select name="subject" id="subject" class="form-control select2-design cal-padding-0 js-example-basic-multiple w-100">
                                                <option value="">Select Subject</option>
                                                @foreach ($masterSubjectData as $subject)
...
<script>
    var _HUB_RECORD_LIST ="{{ url('hub-notes-report/ajax-list')}}";
    var _HUB_RECORD_CSV ="{{ url('hub-notes-report/export-csv')}}";
...
<script src="{{ asset('assets/vendors/select2/select2.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/modulejs/hubRecordNotesReport/hubRecordNotesReport.js')}}?time={{ env('timestamp')}}"></script>
