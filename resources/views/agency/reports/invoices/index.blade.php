        ...
        <div class="reports-header">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="{{ route('agency.invoices.index') }}" class="invoice-badge-btn btn-secondary btn-sm invoice-action-btn">
                    ...
                    <div class="stats-card animate-fade-up" data-delay="100">
                        <div class="stats-content">
                            ...
                            <div class="stats-info">
                                <h5 class="stats-number">{{ \App\Model\Invoice::whereIn('agency_id', array_merge(\App\Helpers\Utility::getUserWiseAgency(), [Auth::user()->agency_fk]))->count() }}</h5>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="stats-card animate-fade-up" data-delay="200">
                        <div class="stats-content">
                            ...
                            <div class="stats-info">
                                <h5 class="stats-number">{{ \App\Model\Invoice::whereIn('agency_id', array_merge(\App\Helpers\Utility::getUserWiseAgency(), [Auth::user()->agency_fk]))->where('status', 'paid')->count() }}</h5>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="stats-card animate-fade-up" data-delay="300">
                        <div class="stats-content">
                            ...
                            <div class="stats-info">
                                <h5 class="stats-number">{{ \App\Model\Invoice::whereIn('agency_id', array_merge(\App\Helpers\Utility::getUserWiseAgency(), [Auth::user()->agency_fk]))->whereIn('status', ['sent', 'overdue'])->count() }}</h5>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="stats-card animate-fade-up" data-delay="400">
                        <div class="stats-content">
                            ...
                            <div class="stats-info">
                                <h5 class="stats-number">${{ number_format(\App\Model\Invoice::whereIn('agency_id', array_merge(\App\Helpers\Utility::getUserWiseAgency(), [Auth::user()->agency_fk]))->whereIn('status', ['sent', 'overdue'])->sum('total_amount'), 0) }}</h5>
        ...
        <div class="quick-actions-section">
            ...
            <div class="row g-2">
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('agency.invoices.index', ['status' => 'overdue']) }}" class="quick-action-card">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('agency.invoices.index', ['status' => 'paid']) }}" class="quick-action-card">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('agency.reports.invoices.summary') }}" class="quick-action-card">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('agency.invoices.index') }}" class="quick-action-card">
                        <div class="quick-action-icon bg-gradient-primary">
                            <i class="mdi mdi-file-document-multiple"></i>
                        </div>
                        <span class="quick-action-text">All Invoices</span>
                    </a>
                </div>
            </div>
        </div>
