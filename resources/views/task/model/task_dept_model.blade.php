<div class="modal fade modal-container" id="task_dept_modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Department <span class="" style="font-size: 18px;"><span id="task_id"></span></h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="field-label" for="due_date">Department</label>                            
                            <select class="form-control js-example-basic-single" name="edit_department_id" id="edit_department_id">
                            ...
                            <span id="task_dept_id_error" class="error"></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="saveTaskDept();">Update</button>
