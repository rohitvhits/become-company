<div class="modal fade modal-container" id="bulk-assign-portal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Bulk Assign Portal<span class="" style="font-size: 18px;"><span id="task_id"></span></h4>
                <div class="modal-close-wrapper ml-4">
                    <button type="button" class="close form-clear url-clear close-modal" data-dismiss="modal" aria-label="Close" style="margin: unset;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="field-label" for="bulk_portal_id">Patient/Portal ID<span class="text-danger">*</span></label>
                            <input type="text" name="bulk_portal_id" id="bulk_portal_id" placeholder="Enter Patient/Portal ID" class="form-control" min="1">
                            <span id="bulk_portal_id_error" class="error"></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="bulkAssignPortal();">Update</button>
