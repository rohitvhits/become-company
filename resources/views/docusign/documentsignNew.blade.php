            ...
            <div class="col-md-8">
                <div class="light-card document">
                   ...
                   <input type="hidden" name="" id="tempids" value="">
                        ...
                        <?php } else{ ?>
                        <iframe src='https://www.view.officeapps.live.com/op/embed.aspx?src=<?php echo URL::to('/');?>/public/dosusinguploads/<?php echo $document_pdf->upload_document;?>' width='100%' height='1000px' frameborder='0'></iframe>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
var url = '<?php echo URL::to('/');?>/dosusinguploads/docusign/<?php echo $document->sourceFile;?>';
    ...
    <script src="<?php echo URL::to('/');?>/assets/js/signerNew.js?maNameIsKhan=<?php echo strtotime(now());?>"></script>
...
if('<?php echo $sent_on;?>' == val.signer_id ||  (val.temp1 =='intake')  || val.placeHolder == "Date Signed"){
			if(val.type =='radio'){
	   ...
	   if(cnt !=0){ 
		...
		return false;
			...
			var actions = JSON.stringify(final_array);
				...
				var href="<?php echo URL::to('/');?>/document-Insert-View";
