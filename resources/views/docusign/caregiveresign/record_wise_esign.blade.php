...
<head>
    ...
    <link href="{{ asset('assets/esign/Ionicons/ionicons.min.css')}}" rel="stylesheet">
    <link
    ...
    <link href="{{ asset('assets/esign/libs/select2/css/select2.min.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/esign/libs/tagsinput/bootstrap-tagsinput.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/esign/simcify.min.css')}}" rel="stylesheet">
    <!-- Signer CSS -->

    <script src="{{ asset('assets/esign/js/jscolor.js')}}"></script>
    <link href="{{ asset('assets/esign/AdminLTE.min.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/esign/libs/jquery-ui/jquery-ui.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/esign/style1111.css')}}?id=<?php echo time(); ?>" rel="stylesheet">
    <script src="{{ asset('assets/esign/js/jquery-3.2.1.min.js')}}"></script>
    <link rel="stylesheet" href="{{ asset('assets/plugins/font-awesome-4.6.3/font-awesome.min.css')}}">
...
<style>
    ...
    * {
    ...
    .document-pagination .pull-left,
    .document-pagination .pull-right {
        display: flex;
        align-items: center;
        gap: 12px;
    }
    ...
    .document-pagination button:hover {
    ...
    .document-pagination .text-muted {
        color: #ffffff !important;
        font-weight: 500;
        font-size: 14px;
        padding: 6px 14px;
    ...
    .finishButtons:hover {
        background: #ed1414 !important;
        box-shadow: 0 4px 12px rgba(237, 20, 20, 0.3);
        transform: translateY(-1px);
    }

    .prevButtons:active,
    .nextButtons:active,
    .finishButtons:active {
        transform: translateY(0);
    }
    ...
    .show_existing_signatures_new {
        height: calc(100vh - 410px);
        overflow-y: auto;
        overflow-x: hidden;
    }

    .show_existing_signatures_new::-webkit-scrollbar {
        width: 8px;
    }

    .show_existing_signatures_new::-webkit-scrollbar-track {
        background: #f1f3f5;
        border-radius: 10px;
    }

    .show_existing_signatures_new::-webkit-scrollbar-thumb {
        background: #667eea;
        border-radius: 10px;
    }

    .cust-edit-btn .form-group {
        margin-bottom: 4px;
        margin-top: 4px;
    }
    ...
    .top-navbar .navbar-brand-wrapper .navbar-brand {
        color: #27367f;
        font-size: 1.5rem;
        line-height: 48px;
        margin-right: 0;
    ...
    .top-navbar .navbar-brand-wrapper .navbar-brand img {
        max-width: 100%;
        height: 40px;
        margin: auto;
        vertical-align: middle;
...
<body>
    ...
    <div class="header-right" style="display:none">
        <div class="header-actions">
            <div class="page-actions">
                <button class="btn btn-success btn-responsive launch-editor" style="display:inline-block !important;">
                    <i class="ion-edit"></i> Manage Fields & Edit
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="content" style="">
            @if(isset($document_all_details->upload_document) && $document_all_details->upload_document !="")
                <div class="row">
                    <div class="col-md-8">
                        <div class="light-card document">
                            <div class="signer-document">
                                ...
                                @if($temp == 'pdf')
                                    <div class="document-pagination">
                                        ...
                                        <div class="pull-right">
                                            <button class="btn btn-default btn-round btn-zoom" style="margin-top:1px !important" zoom="plus"><i
                                                    class="ion-plus"></i></button>
                                            <button class="btn btn-default btn-round btn-zoom" style="margin-top:1px !important" zoom="minus"><i
                                ...
                                @else
                                    <iframe title="Test"
                                        src='https://www.view.officeapps.live.com/op/embed.aspx?src={{ asset("public/uploads")}}/{{ $document_all_details->upload_document}}'
        ...
        <div class="signer-overlay">
            <div id="signer-overlay-header" class="page-header">
                <nav class="navbar top-navbar col-lg-12 col-12 p-0" style="margin-top:-10px">
                    <div class="container-fluid">
                    <div class="text-center navbar-brand-wrapper d-flex align-items-center ml-4">
                            <a class="navbar-brand brand-logo" href="{{ url()->previous()}}"><img src="{{ asset('img/logo-ny.png')}}" alt=""></a>
                        </div>
                    </div>
                </nav>
            ...
            <div class="col-md-2"></div>
                <div class="col-md-8">
                    ...
                    <input type="button" value="Next" class="btn btn-primary nextButtons" onclick="onNextPage()"
                    ...
                    onclick="submitResponse();" style="clear:both;display:none;float: left;">
            ...
            <div class="signer-overlay-footer"></div>
                ...
                <div class="modal-body">
                    <div id="signature-pad" class="signature-pad">
                        <div class="signature-pad--body">
                            <div class="row">
                                <div class="col-md-4 edit_selected_checked" data-val="Draw">
                                    <h4><input type="radio" name="typebod" checked value="0" /> Draw </h4>
                                </div>
                                <div class="col-md-4 edit_selected_checked" data-val="Type">
                                    <h4><input type="radio" name="typebod" value="1" />Type</h4>
                                </div>
                                <div class="col-md-4 edit_selected_checked" data-val="Upload">
                            ...
                            <div id="fileUploadBody">
                                <div class="row">
                                    <input type="hidden" name="login_id" id="login_id" value="{{auth()->user()->id}}">
                                       
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="file_upload">Upload Signature</label>  <span style="color:red">*</span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="show_existing_signatures_new" id="show_existing_signatures"></div>
    ...
    <div class="modal fade" id="modal-default-stamp" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="signature-pad-stamp" class="signature-pad-stamp">
                        <div class="signature-pad--body">
                            <input type="hidden" id="stampId">
                            <div id="fileUploadBodyStamp">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" name="type" id="type" value="stamp">
                                        <input type="hidden" name="login_id" id="loginId" value="{{auth()->user()->id}}">
                                        <input type="file" class="form-control" value="" name="file_upload"
                                            id="stamp_upload">
                                        <div id="error_stamp_message" style="color: red; margin-top: 5px;"></div>
                                    </div>
                                    <div class="col-md-1">
...
<script src="{{ asset('assets/esign/js/simcify.min.js')}}"></script>
<script src="{{ asset('assets/esign/libs/clipboard/clipboard.min.js')}}"></script>
<script src="{{ asset('assets/esign/libs/jquery-ui/jquery-ui.min.js')}}"></script>
<script src="{{ asset('assets/esign/libs/select2/js/select2.min.js')}}"></script>

<script src="{{ asset('assets/esign/js/jquery.slimscroll.min.js')}}"></script>
<script src="{{ asset('assets/esign/libs/jcanvas/jcanvas.min.js')}}"></script>
<script src="{{ asset('assets/esign/js/touch-punch.min.js')}}"></script>
<script src="{{ asset('assets/esign/libs/jcanvas/editor.min.js')}}"></script>
<script src="{{ asset('assets/esign/js/pdf.js')}}"></script>
<script src="{{ asset('assets/modulejs/stamp_user.js') }}?time={{ time() }}"></script>

<script type="text/javascript">
    var getChatUrl ="";
 
    var url = '{{ url("template/getpdfbyTemplateid")}}?template_id={{ $document_all_details->templete_id}}',
    ...
    sendRequestUrl = '{{ url("/template_send1")}}',
    createTemplateUrl = '',
    baseUrl = '{{ url("/")}}',
    auth = true;
    document_key = '{{ $document_all_details->id ?? "" }}';
    permission: "permission";
    tokens = "{{ csrf_token() }}";
    PDFJS.disableWorker = true;
    PDFJS.workerSrc = '{{ asset("assets/esign/js/signer.min.js")}}?id={{ time()}}';
    var savedWidth = '{{ $document_all_details->docWidth }}';
    var templateFields = <?php echo $signInsert;?>;
    var LookUpResponses =<?php echo $lookUpResponses;?>;
    var sessionIds = '{{ $sessionIds}}';
    var main_intakeId = "{{ $document_all_details->main_intakeId}}";
    var docusignId = '{!! json_encode($sent_on1)!!}';
    var maximumPgaes = "{{ $max}}";
    var pdfGenerateOrNot = "{{ $document_all_details->pdfgenerate ?? '' }}";
    ...
    var times = "{{ time() }}";
    var mainURL = "{{ url('/')}}";
    var templateID = "{{ $document_all_details->templete_id }}";
    var document_report_id = "{{ $document_all_details->id}}";
    var _CSRF_TOKEN = "{{ csrf_token() }}";
    var signaturePads = {};
    var _CHECK_AUTH_LOGIN = "{{ auth()->user()->id ??''}}";
    var _VIEW_ESIGN_TYPE="edit";
</script>

<!-- custom scripts -->
<script src="{{ asset('assets/esign/js/signature_pad.umd.js')}}"></script>
<script src="{{ asset('assets/esign/js/app.js')}}"></script>
<script src="{{ asset('assets/esign/js/appsignaturepad.js')}}?{{ strtotime(now()) }}"></script>
<script src="{{ asset('assets/esign/js/signature_pad.min.js')}}"></script>
<script src="{{ asset('assets/esign/js/signerNew12.js')}}?{{ strtotime(now())}}"></script>
<script src="{{ asset('assets/esign/js/render_new.js')}}?{{ strtotime(now())}}"></script>
<script src="{{ asset('assets/esign/js/custom.js')}}?{{ strtotime(now())}}"></script>
<script src="{{ asset('assets/esign/libs/sweetalert/sweetalert.min.js')}}"></script>
<script>
    var globalNewResponse = [];
    var globalNewResponseImages = [];
    var common_date_mdy = "{{ date('m/d/Y')}}";
...
<script>
    ...
    function getSignatureSuccess(filename, id, type = "",docusignType="") {
        ...
        if (type === "upload" || type === "select" || type === "upload_stamp") {
            ...
            $("#img" + id).attr('src', '{{ url("dosusinguploads/docusign/")}}' + res);
        }
        ...
        $('.signeeddate').val(common_date_mdy);
        var uploadSelect = 0;
    ...
    function myStamp(id) {
        ...
        if(globalStamp ==0){
            globalStamp = 1;
            getWebviewCanvasStamp("{{ $id }}", "{{ $rand }}", id);
        }
    }

    function myStampUser(id) {
        getStampUser("{{ $id }}", "{{ $rand }}", id);
    }
    ...
    function submitResponse() {
        ...
        $.each(globalResponse, function(index, val) {
            ...
            if (val.type == 'radio' && (docusignId.includes(val.signer_id.toLowerCase()))) {
            ...
            if (val.type == 'checkbox' && (docusignId.includes(val.signer_id.toLowerCase()))) {
            ...
            if (val.type == "image"  && (docusignId.includes(val.signer_id.toLowerCase()))) {
            ...
            if (val.type == "stamp"  && (docusignId.includes(val.signer_id.toLowerCase()))) {
                imgRequired = $("#img" + i).attr('dataids');
                width = '';
                height = '';
                value = $("#img" + i).attr('src');
            ...
            if (val.type == 'dropdown' && (docusignId.includes(val.signer_id.toLowerCase()))) {
            ...
            if (val.type == 'text'  && (docusignId.includes(val.signer_id.toLowerCase()))) {
            ...
            if (docusignId.includes(val.signer_id.toLowerCase()) || (val.temp1 == 'intake' || val.temp1 ==
                    'caregiver') || val.placeHolder == "Date Signed") {
                if (val.type == 'radio') {
        ...
        if (cnt != 0) {
            ...
            if(globalNewResponseImages.length > 0){
                ...
                showLoader();
                var href = "{{ url('esign/docusign/record-wise-submit-form')}}";
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'id': '{{ $document_all_details->templete_id }}',
                        'action':  encodeURIComponent(actions),
                        "sessionId": "{{ $sessionIds}}",
                        'document_report_id': "{{ $document_all_details->id}}",
                        "groupId": "{{ $document_all_details->groupId }}",
                        "permission": headers,
                        '_token': _CSRF_TOKEN,
                        'sent_on': '{{ $sent_on }}',
                        'docWidth':''
    ...
    function getSubmit(blob) {
        ...
        $.ajax({
            ...
            url:'{{ url("esign/docusign/esign-signature")}}', // Upload Script
            headers: {
   ...
   var jsonresp = '{!! Common::getCreateFontWiseImage() !!}';
    ...
    function getCreateNewImages(id) {
        ...
        if (textname != '') {
            $('#createNewImage').html("");
            $.each(JSON.parse(jsonresp), function(i, v) {
    ...
    function getAdminSign() {
        ...
        $('img').each(function(i, v) {
            var id = $(this).attr('id')
            if ($(this).closest('div[type="image"]').length) {
                
                if('img'+globalImageId == id){
                    $("#" + id).attr('src', data);
                    var width = $("#" + id).width();
    ...
    function getSubmitFileUpload(file) {
        ...
        formData.append("signature_name", $('#signature_name').val());
        formData.append("login_id", $('#login_id').val());
        formData.append("_token", _CSRF_TOKEN);
        $.ajax({
            url: "{{ url('esign/docusign/upload-signature')}}",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'POST',
            ...
            success: function (response) {
                ...
                if(response.data.length !=0){
                    $.each(response.data,function(i,v){
                        ...
                        htmlResponse +=`<div class="col-md-6 mb-3">
                            <div class="signature-wrapper"
                                style="position: relative;margin:0px 0px 10px 0px; border: 1px solid #ccc; background: #fff; border-radius: 8px; padding: 10px; text-align: center;"
                                data-id="${v.id}">
                ...
                if(response.data.length !=0){
                    $.each(response.data,function(i,v){
                        htmlResponse +=`<div class="col-md-6">
                                <div class="signature-wrapper"
                                    style="position: relative; border: 1px solid #ccc; background: #fff; border-radius: 8px; padding: 10px; text-align: center;"
                                    data-id="${v.id}">
...
<script>
    ...
    $('.edit_selected_checked').click(function(e){
    ...
    function showErrorAndLoginRedirection(xhr) {
        if (xhr.status === 401) {
            ...
            // Show message
            alert(`Session expired. Redirecting in <span id="countdown">${countdown}</span> seconds...`);
            // Countdown update
