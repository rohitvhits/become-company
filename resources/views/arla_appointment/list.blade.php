...
<div class="main-panel">
    ...
    <div class="content-wrapper">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Arla Aid List (<span id="appointment_id"></span>)</h5>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Services<span class="error">*</span>:</label><br>
    ...
    @include('arla_appointment._partial.show_modal_popup')
    @include('arla_appointment._partial.link_patient_modal')
    @include('arla_appointment._partial.link_service_modal')
    @include('arla_appointment._partial.log_modal')
    @include('arla_appointment._partial.portal_log_modal')
    ...
    <script type="text/javascript">
        var _THIRD_PARTY_VISITING_AID_LIST = "{{ url('arla-ajax-list') }}";
        var _THIRD_PARTY_ADD_APPOINTMENT = "{{ url('add-appointment-arla-patient') }}";
        var _CSRF_TOKEN = '{{ csrf_token() }}';
        var _CHECK_EXISTING_DATA = "{{ url('check-existing-record')}}";
        var _LINK_THIRD_PARTY_APPOINTMENT = "{{ url('link-arla-appointment')}}";
        ...
        var _THIRD_PARTY_PATIENT_EXPORT = "{{ url('arla-appointment/arla-export')}}";
    ...
    <script src="{{ asset('assets/modulejs/arla_aid/arla_aid.js')}}?time={{ env('timestamp')}}"></script>
    <script>
