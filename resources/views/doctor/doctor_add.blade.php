...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Doctor Add</h5>
        </div>
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form class="form-sample" action='<?php echo URL::to('/doctor/save'); ?>' name="adduser" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control charCls"
                                                ...
                                                value="<?php echo old('full_name'); ?>" maxlength="50">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" id="msp"
                                                        name="gender" value="male" <?php if (old('gender') == 'male') {
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" id="msp"
                                                        name="gender" value="female" <?php if (old('gender') == 'female') {
                                                            echo "checked='checked'";
                                                        } ?>> Female<i
                                                        class="input-helper"></i></label>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="Enter Licence "
                                                id="license" name="license" value="<?php echo old('license'); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Zipcode<span
                                                class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" value="<?php echo old('zipcode'); ?>" placeholder="Enter Zipcode " id="zipcode" name="zipcode" onkeypress="return isNumber(event)">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"
                                                ...
                                                name="place_of_examination" value="<?php echo old('place_of_examination'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"
                                                placeholder="yyyy-mm-dd" id="date_of_examination"
                                                name="date_of_examination" value="{{ old('date_of_examination') }}">
                                            <span id="date_of_examination_error"
                                                class="error mt-2">{{ $errors->add_agency->first('date_of_examination') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file"  class="form-control" value="" id="signature_upload" name="signature_upload">
                                            <span id="signature_upload_error" class="error mt-2"><?php echo $errors->add_agency->first('signature_upload'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file"  class="form-control" value="" id="stamp_upload" name="stamp_upload">
                                            <span id="stamp_upload_error" class="error mt-2"><?php echo $errors->add_agency->first('stamp_upload'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control charCls"
                                                ...
                                                value="<?php echo old('specialty'); ?>" maxlength="50">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Registry Number<span
                                                class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" value="<?php echo old('registry_number'); ?>" placeholder="Enter Registry Number " id="registry_number" name="registry_number" onkeypress="return isNumber(event)" maxlength="10">
                                            <span id="registry_number_error" class="error mt-2"><?php echo $errors->add_agency->first('registry_number'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">NPI Number<span
                                                class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" value="<?php echo old('npi_number'); ?>" placeholder="Enter NPI Number " id="npi_number" name="npi_number" onkeypress="return isNumber(event)" maxlength="10">
