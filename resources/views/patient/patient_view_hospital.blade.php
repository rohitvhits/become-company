...
<style>
    ...
    #mq_order_form_submit_id .form-group {
        margin-bottom: 0 !important
    }

    #mq_order_form_submit_id .form-group label {
        margin-bottom: 0 !important
    }
    @keyframes shimmer {
  0% {
...
<div class="main-panel">
        ...
        <div class="dashboard-header d-flex flex-column ">
            ...
            <div class="row">
                ...
                @endif
                    ...
                    <div class="col-md-8 mb-2">
                        <div class="row alert1 alert-fill-danger ml-1  @if($record->archived_at !='') @else hide @endif" role="alert"   id="unrchived_div">
                            <!-- Left Content -->
                ...
                @can('patient-view-page-toggle')
                    <div class="col-md-4">
                        <div class="d-flex justify-content-end align-items-center" style="gap:8px;">
                            <p style="margin-left:-10px">Try New Design </p>
                            <label class="toggle-switch toggle-switch-success patient-toggle patient-bg">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap border-bottom  mb-3">
                ...
                <div class="d-flex align-items-center mb-3 {{$class}}">
                    ...
                    </h4> &nbsp;&nbsp;( <?php echo $record->agency_name; ?> ) <?php if ($record->partner_agency != "" && $record->id != 606647) { ?>- (<?php echo $record->partner_agency; ?>) <?php } ?>
 &nbsp;<a href="javascript:void(0)" title="Copy Full Text" onclick="copyToClipboard('ID # {{ $record->id }} - {{ ucwords($record->first_name) }} {{ ucwords($record->last_name) }} ( {{ $record->agency_name }} )', this)" style="font-size:14px;vertical-align:middle;"><i class="mdi mdi-content-copy"></i></a>
                @can('send-patient-demographic-sms')
                    ...
                    <a class="ml-4" onclick="sendPatientDemographicSMS('{{ $record->mobile}}')">Send SMS To Patient Demographic Details</a>
                    @endif
                @endcan
                <?php
                ...
                <?php if ($user['user_type_fk'] == 184) { ?>
                    ...
                    <div class="button-wrapper d-flex align-items-center mt-md-3 mt-xl-0">
                        <select class="form-control" id="patient_wise_agency_id">
                            <option value="">Select Agency</option>
                        </select>
                        <a id="redirection_page" title="" target="_blank"></a>
                    </div>
                <?php } ?>
            </div>
        </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 15px;">
                                        ...
                                        @endif
                                            ...
                                            <?php if ($auth->login_type_fk == 183) { ?>
                                                ...
                                                <a href="javascript:void(0);" onclick="deleteRecordPatient('{{$record->id}}')" class="pull-right btn btn-danger btn-rounded  btn-sm  d-none d-md-block mr-2" class="pull-right" title="Delete"><i class="fa fa-trash"></i>
                                                    Delete</a>
                                                @endcan
                                                ...
                                                @can('combine-record')
                                                    ...
                                                    <a id="edit_merge_appointment_id" href="javascript:void(0);"  data-toggle="modal" data-target="#exampleModal-merge-record" data-whatever="@mdo" class="pull-right btn btn-secondary btn-rounded  btn-sm  d-none d-md-block mr-2" class="pull-right" title="Merge Record"><i class="fa fa-compress"></i>
                                                    Merge Record</a>
                                                @endcan

                                                <a href="javascript:void(0);" class="pull-right btn btn-success btn-rounded  btn-sm  d-none d-md-block" class="pull-right" title="Assign" style="margin-right: 10px;" data-toggle="modal" class="pull-right" data-target="#assignModal" onclick="showAssignAppointmentData('{{ $record->assign_user_id}}')"><i class="fa fa-check"></i> Assign</a>
                                                @if(strtolower($record->type) == 'caregiver')
                                                <div class="btn-group pull-right status-dropdoown mr-2">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuSplitButton6">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="pending" onclick="getModals('pending')">Pending</a>
                                                        @endif
                                                        @if ($record->status == 'Pending' && $record->status != 'refused')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="booked" onclick="getModals('booked')">Scheduled</a>
                                                        @endif
                                                        @if ($record->status != 'completed' &&
                                                        $record->status != 'cancelled' &&
                                                        $record->status != 'refused' &&
                                                        $record->status != 'noshow')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="checkin" onclick="getModals('checkin');">Mark as CheckIn</a>
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="processing" onclick="getModals('processing');">Mark as Processing</a>
                                                        @endif
                                                        @if (strtolower($record->status) != 'cancelled' && $record->status != 'noshow' && $record->status != 'refused')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="complete" onclick="getModals('complete');">Mark as Completed</a>
                                                        @endif
                                                        @if ($record->status != 'completed' &&
                                                        $record->status != 'refused' &&
                                                        $record->status != 'cancelled' &&
                                                        $record->status != 'noshow')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" class="pull-right" id="cancel" data-toggle="modal" data-target="#exampleModal-cancel" data-whatever="@mdo">Mark as Cancel</a>
                                                        @endif
                                                        @if ($record->status != 'completed' && $record->status != 'noshow' && $record->status != 'refused')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" class="pull-right" id="noshow" onclick="getModals('noshow');">Mark as NoShow</a>
                                                        @endif
                                                        @if ($record->status != 'completed')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="refused" onclick="showRefuseModal()">Mark as refused</a>
                                                        @endif
                                                        @if ($record->prev_status != '')
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="undo" onclick="Undo(<?php echo $record->id; ?>)">Undo</a>
                                                        @endif
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="hospitalized" onclick="getModals('hospitalized')">Mark as
                                                            Hospitalized/Rehab</a>
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="unableToContact" onclick="getModals('unableToContact')">Unable To Contact</a>
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="PendingTermination" onclick="getModals('PendingTermination')">Pending Termination</a>
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="Onhold" onclick="getModals('Onhold')">On hold</a>
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="Onleave" onclick="getModals('Onleave')">On leave</a>
                                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" id="Terminated" onclick="getModals('Terminated')">Terminated</a>
                                                ...
                                                @endif
                                                @if($record->status =='completed')
                                                <a data-toggle="modal" class="pull-right btn btn-info btn-rounded btn-sm d-none d-md-block mr-2" data-target="#serviceByPatientTypeModal"
                                                    style="color:#fff" onclick="getPatientId('{{ $record->id}}');">
                                            ...
                                            <?php if ($user['user_type_fk'] == 5) { ?>
                                                @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                    @if($editAppointmentFlag ==1)
                                                        <a href="<?php echo URL::to('/'); ?>/patient/edit/<?php echo $record->id; ?>" class="pull-right btn btn-secondary btn-rounded  btn-sm  d-none d-md-block" class="pull-right" title="Edit" style="margin-right: 10px;"><i class="fa fa-edit"></i> Edit</a>
                                                    @endif
                                                @endif
                                            <?php } else { ?>
                                                <?php if ($auth->login_type_fk == 183) { ?>
                                            ...
                                            <?php if ($user['user_type_fk'] == 184 || $user['user_type_fk'] == 6) { ?>
                                                ...
                                                ?>
                                                    ...
                                                    <?php if ($user['user_type_fk'] == 184) {
                                                        ...
                                                        ?>
                                                        <a href="javascript:void(0)" class="pull-right btn btn-info btn-sm btn-rounded  d-none d-md-block" data-toggle="modal" data-target="#exampleModal-4" onClick="scheduleAppointmentSelected();" data-whatever="@mdo" style="margin-right: 10px;" title="Schedule Appointment"> Schedule
                                                            Appointment</a>
                                                    <?php }
                                                    ...
                                                    <?php if ($user['user_type_fk'] == 184) { ?>
                                                        @if($record->type == 'Caregiver')
                                                            <a href="javascript:void(0)" class="pull-right btn btn-info btn-rounded  btn-sm  d-none d-md-block" data-toggle="modal" class="pull-right" data-target="#exampleModal-44" data-whatever="@mdo" style="margin-right:10px" title="Telehealth Appointment"> Telehealth
                                                                Appointment</a>&nbsp;&nbsp;
                                            ...
                                            <?php if ($user['user_type_fk'] == 6 && $user['login_type_fk'] == 2) { ?>
                                                @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                    @if($editAppointmentFlag ==1)
                                                        <a href="javascript:void(0)" class="pull-right btn btn-info btn-sm btn-rounded  d-none d-md-block" data-toggle="modal" data-target="#exampleModal-23" data-whatever="@mdo" style="margin-right: 10px;" title="Request for  Appointment"> Request for Appointment</a>
                                                        @endif
                                                @endif
                                            <?php } ?>
                                            @can('resolution-chart')
                                                @if(strtolower($record->type) == 'patient')
                                                    <a data-fancybox data-src="#patientResolutionModal" href="javascript:;" class="pull-right btn btn-primary btn-rounded  btn-sm  d-none d-md-block mr-2" style="padding: 0.282rem 12px">
                                                        Resolution chart
                                                    </a>
                                                @endif
                                            @endcan
                                        ...
                                        <div class="box">
                                            ...
                                            <dt> Patient Code</dt>
                                                ...
                                                <dd>
                                                    ...
                                                    >
                                                        @if($record->mobile !="")
                                                        {{preg_replace('/(\d{3})(\d{3})(\d{4})/', '($1) $2-$3', $record->mobile)}}
                                                        @else
                                                            -
                                                        @endif
                                                    </span>
                                                    @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                            @if($editAppointmentFlag ==1)
                                                            <a class="mr-1" data-toggle="modal" data-target="#exampleModal-mobile" data-whatever="@mdo" title="Mobile" onclick="updateMobileDetails()"><i class="fa fa-edit"></i></a>
                                                ...
                                                <dt> Phone</dt>
                                                <dd> <span id="record_phone_id"><?php echo preg_replace('/(\d{3})(\d{3})(\d{4})/', '($1) $2-$3', $record->phone); ?></span>
                                                    @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                        @if($editAppointmentFlag ==1)
                                                            <a class="mr-1" data-toggle="modal" data-target="#exampleModal-phone" data-whatever="@mdo" title="Phone" onclick="updatePhoneDetails()"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                ...
                                                <dd><span id="patient_dob"><?php if ($record->dob != '0000-00-00') {
                                                    ...
                                                    @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                        @if($editAppointmentFlag ==1)
                                                        <a data-toggle="modal" data-target="#exampleModal-dob" data-whatever="@mdo" title="Date Of Birth"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                    @endif
                                                </dd>
                                                ...
                                                if ($record->type    == 'Caregiver') {
                                                    if ($record->agency_id  == '319'  ||  $record->agency_id  == '106') { ?>
                                                        ...
                                                        <dd><span id="emergency_phones"><?php if ($record->emergency_phone != '') {
                                                            ...
                                                            <a data-toggle="modal" data-target="#exampleModal-emergency_phone" data-whatever="@mdo" title="Emergency Phone" onclick="updatePhoneDetails('{{ $record->emergency_phone}}')"><i class="fa fa-edit"></i></a>
                                                        </dd>
                                                        ...
                                                        <dd><span id="emergency_email"><?php if ($record->email != '') {
                                                            ...
                                                            <a data-toggle="modal" data-target="#exampleModal-email" data-whatever="@mdo" title="Email" onclick="updateEmailDetails('{{ $record->email}}')"><i class="fa fa-edit"></i></a>
                                                        </dd>
                                                <?php  }
                                                } ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            if($record->appointment_date !=""){
                                                echo Common::convertMDY($record->appointment_date);
                                            }else{
                                                echo '-';
                                            }
                                            ?></dd>
                                            ...
                                            <?php } ?>
                                            <dt>Booked Via</dt>
                                            <dd style="white-space:nowrap"><?php
                                            if($record->appointment_mode !=""){
                                                echo ucfirst($record->appointment_mode);
                                            }else{
                                                echo "-";
                                            }
                                             ?></dd>
                                            ...
                                            <dd>
                                                <span id="attachment_pdf_ids">
                                                    ...
                                                    <a href="/dpa/{{$record->id}}" target="_blank">Download <i class="fa fa-download"></i></a>
                                                    @else
                                                        -
                                                    @endif
                                                </span>
                                                @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                    @if($editAppointmentFlag ==1)
                                                        @if ($record->attachment_document == '')
                                                            <a class="ml-2" data-toggle="modal" data-target="#exampleModal-attachment" data-whatever="@mdo" title="Attachment"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                    @endif
                                            ...
                                            <dt>Payment Type</dt>
                                            <dd style="white-space:nowrap"><span id="payment_type_id">
                                            @if($record->payment_type_new !="")
                                            {{ $record->payment_type_new }}
                                            @else
                                                -
                                            @endif
                                            </span>
                                            @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                    @if($editAppointmentFlag ==1)
                                                    <a class="ml-2" data-toggle="modal" data-target="#exampleModal-payment-type" data-whatever="@mdo" title="Payment Type"><i class="fa fa-edit"></i></a>
                                                    @endif
                                            @endif
                                            </dd>
                                            <?php if ($record->agency_id  != '319'  && $record->agency_id  != '106') { ?>
                                                ...
                                                <dd id="next_apid"><?php if ($record->next_appoinment_date != '') {
                                                                        echo date('m/d/Y', strtotime($record->next_appoinment_date)); }else{ echo '-';  } ?>
                                                @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                    @if($editAppointmentFlag ==1)
                                                    <a class="ml-2" data-toggle="modal" data-target="#exampleModal-70" data-whatever="@mdo" title="Next Appointment Date"><i class="fa fa-edit"></i></a>
                                                    @endif
                                            ...
                                            <dd><?php if ($record->due_date != '' && $record->due_date != '1969-12-31' && $record->due_date !="0000-00-00") {
                                                ...
                                                @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                    @if($editAppointmentFlag ==1)
                                                    <a class="ml-2" data-toggle="modal" data-target="#exampleModal-67" data-whatever="@mdo" title="Due Date"><i class="fa fa-edit"></i></a>
                                                    @endif
                                            ...
                                            <?php if ($record->type    == 'Caregiver') {
                                                if ($record->agency_id  == '319'  ||  $record->agency_id  == '106') { ?>
                                                    ...
                                                    <dd><?php
                                                        ...
                                                        @if($editAppointmentFlag ==1)
                                                        <a class="ml-2" data-toggle="modal" data-target="#exampleModal-traning_due_date" data-whatever="@mdo" title="Training Due Date" onclick="updateTrainingDueDate('{{ $traning_due_date}}')"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                    </dd>
                                            <?php  }
                                            } ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            <?php if ($record->completed_date != '') { ?>
                                                ...
                                                <dd><span id="comp_id"><?php if ($record->completed_date != '' && $record->completed_date != '1969-12-31' && $record->completed_date != '0000-00-00 00:00:00') {
                                                                        ...
                                                                        @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                                        @if($editAppointmentFlag ==1)
                                                <a class="ml-2" data-toggle="modal" data-target="#exampleModal-complete" data-whatever="@mdo"><i class="fa fa-edit"></i></a>
                                                @endif
                                                @endif
                                                </dd>
                                            <?php } ?>
                                            ...
                                            <dt>Language </dt>
                                            <dd><span id="record_languages_res_id"><?php echo $record->languages != null ? $record->languages->name : '-'; ?></span>
                                                <input type="hidden" id="record_languages_id" value="<?php echo $record->languages != null ? $record->languages->id : ''; ?>">
                                                @if(!in_array(auth()->user()->id,Common::agencyPortalRolePermission()))
                                                @if($editAppointmentFlag ==1)
                                                    <a class="ml-2" data-toggle="modal" data-target="#exampleModal-languages" data-whatever="@mdo" title="Languages" onclick="updateLanguageDetails()"><i class="fa fa-edit"></i></a>
                                                    @endif
                                                @endif
                                                <br>
                                            </dd>
                                            ...
                                            <?php if ($record->status == 'cancelled' || $record->status == 'refused') { ?>
                                                <dt> Reason</dt>
                                                <dd>
                                                    <?php echo $record->reasonname; ?>
                                                    @if(!empty($record->otherreasonname))
                                            ...
                                            <?php if ($record->agency_id  != '319'  && $record->agency_id  != '106') { ?>
                                                <dt> Assigned To </dt>
                                                <dd> {{$record->assign_user!=""?$record->assign_user:"-"}}</dd>
                                            <?php } ?>
                                            ...
                                            <dd> <?php echo Common::convertMDY($record->updated_date) . '<br>'; ?></dd>
                                            <dt> Last Updated By </dt>
                                            <dd> {{$record->updatedBy}} @if($record->updateUserTypes !="")({{ $record->updateUserTypes }})@endif</dd>
                                            <dt>Notes</dt>
                                            <dd>
                                                <input type="hidden" id="html_patient_nots"  value="{{ $record->remarks}}">
                                                    <span id="html_patient_notes_id">
                                                    <?php echo $record->remarks == null ? '-' : $record->remarks ; ?>
                                                    </span>
                                            ...
                                            if ($record->type    == 'Caregiver') {
                                                if ($record->agency_id  == '319'  ||  $record->agency_id  == '106'  ||  $record->agency_id  == '43') { ?>
                                                    ...
                                                    <dd><span id="inservices_status"> {{ ($record->inservice_status !="")?$record->inservice_status:"-" }}</span><a class="ml-2" data-toggle="modal" data-target="#exampleModal-inservice_status" data-whatever="@mdo"><i class="fa fa-edit"></i></a><br></dd>

                                                    <dt>In Service Status Second</dt>
                                                    <dd><span id="inservices_status_two"> {{ ($record->inservice_status_two !="")?$record->inservice_status_two:"-" }}</span><a class="ml-2" data-toggle="modal" data-target="#exampleModal-inservice_status_two" data-whatever="@mdo"><i class="fa fa-edit"></i></a><br></dd>
                                            <?php }
                                            } ?>

                                            @if($record->agency_id  == '43')
                                            <dt>In Service Due Date </dt>
                                            <dd><span id="inservices_dates"> {{ ($record->inservice_datetime !="")?date('m/d/Y  h:i A',strtotime($record->inservice_datetime)) :"-" }}</span><br></dd>
                                            ...
                                            <dd><span id="hhx_alaycare_client_id"> {{ ($record->alaycare_id != "") ? $record->alaycare_name . ' (' . $record->alaycare_id . ')' : "-" }}</span>&nbsp;&nbsp;
                                                @if($user['user_type_fk'] == 184 )
                                                <a class="ml-2" data-toggle="modal" data-target="#exampleModal-link-alaycare-client-id" id="alaycare-client-popup" data-whatever="@mdo"><i class="fa fa-edit"></i></a><br>
                                                @endif
                                            </dd>
                                            <input type="hidden" id="alayacare_existing_client_id" value="{{ $record->alaycare_id}}">

                                            @else
                                            <dd><span id="hhx_alaycare_id"> {{ ($record->alaycare_id != "") ? $record->alaycare_name . ' (' . $record->alaycare_id . ')' : "-" }}</span>&nbsp;&nbsp;
                                                @if($user['user_type_fk'] == 184 )
                                                <a class="ml-2" data-toggle="modal" data-target="#exampleModal-link-alaycare-id" id="alaycare-popup" data-whatever="@mdo"><i class="fa fa-edit"></i></a><br>
                                                @endif
                                            </dd>
                                            ...
                                            @if( isset($agencyDetails->robort_status) && $agencyDetails->robort_status ==1)
                                            <dt>Remote Id </dt>
                                            <dd><span id="hhx_robort_id"> {{ ($record->robort_id != "") ? $record->remote_name : "-" }}</span>
                                                @if($user['user_type_fk'] == 184 )
                                                <a class="ml-2" data-toggle="modal" data-target="#exampleModal-link-remote-id" id="remote-popup" data-whatever="@mdo"><i class="fa fa-edit"></i></a><br>
                                                @endif
                                            </dd>
                                            ...
                                            if ($record->type    == 'Caregiver') {
                                                if ($record->agency_id  == '319'  ||  $record->agency_id  == '106') { ?>
                                                    ...
                                                    <dd><span id="training_statuss"> {{ ($record->training_status !="")?$record->training_status:"-" }}</span><a class="ml-2" data-toggle="modal" data-target="#exampleModal-training_status" data-whatever="@mdo" onclick="updateDetails('{{ $record->training_status}}')"><i class="fa fa-edit"></i></a><br></dd>
                                            ...
                                            if ($record->agency_id  == '319'  ||  $record->agency_id  == '106') { ?>
                                                ...
                                                <dd><span id="{{ $record->agency_id}}_follow_update"> {{ ($record->follow_date !="")?date('m/d/Y',strtotime($record->follow_date)):"-" }}</span><a class="ml-2" data-toggle="modal" data-target="#exampleModal-follow_date" data-whatever="@mdo"><i class="fa fa-edit"></i></a><br></dd>
                                            ...
                                            <dd><span id="link_third_party_id"> {{ ($record->link_third_party != "") ? $record->link_third_party_name: "N/A" }}</span>&nbsp;&nbsp;
                                                @if($user['user_type_fk'] == 184 )
                                                <a class="ml-2" data-toggle="modal" data-target="#exampleModal-link-third-party-id" id="link-third-party-popup" data-whatever="@mdo" onclick="linkThirdParty()"><i class="fa fa-edit"></i></a><br>
                                                @endif
                                            </dd>
                                            ...
                                            <dt>Medicare No</dt>
                                            <dd>@if($record->medicare_no !=""){{ $record->medicare_no}} @else - @endif</dd><br>
...
<!--
                                            @if($record->merge_appointment_id !='')
                                                <dt id="appointment_merge_id" style="display:@if($record->merge_appointment_id !='')@else none @endif">Merged Id</dt>
                                            ...
                                            <dd>
                                                ...
                                                <span id="link_visiting_aid_id"> @if(isset($visiting_links['Visiting Aid'][0]->id)) {{ $visiting_links['Visiting Aid'][0]->third_party_first_name.' '.$visiting_links['Visiting Aid'][0]->third_party_last_name }} ( {{ $visiting_links['Visiting Aid'][0]->third_party_code }}) @endif</span>
                                                @if($user['user_type_fk'] == 184 )
    ...
    <dl class="dl-horizontal">
        ...
        <dd>
            <span id="portal-field-{{ $portalField['fields']['id'] }}">
                @if($portalField['fields']['type'] === 'date' &&
                isset($patientAdvanceSubmitData[$portalField['agency_id']][$portalField['fields']['id']]))
                {{
                \Carbon\Carbon::parse($patientAdvanceSubmitData[$portalField['agency_id']][$portalField['fields']['id']])->format('m/d/Y')
                }}
                @elseif($portalField['fields']['type'] === 'time' &&
                isset($patientAdvanceSubmitData[$portalField['agency_id']][$portalField['fields']['id']]))
                {{
                \Carbon\Carbon::parse($patientAdvanceSubmitData[$portalField['agency_id']][$portalField['fields']['id']])->format('h:i
                A') }}
                @else
                ...
                <div class="card">
                    <div class="left-section-main">
                        <ul class="nav nav-tabs tabs-left sideways left-section-ul">
                            ...
                            @if($record->hha_id !="" || $record->link_hha_caregiver !="" || $record->link_hha_patient !="")
                            <li>
                                <a href="#hha-exchange" data-toggle="tab" onClick="loadHHaSection()">HHA Exchange &nbsp;&nbsp; <img src="{{ asset('/img/hha.png')}}" title="HHA" alt="HHA" style="height: 17px; width: 17px;"></a>
                            </li>
                            ...
                            @if(strtolower($record->type) == 'patient' && !empty($record->task_health_link))
                                @can('patient-task-health-visit-list')
                                    <li>
                                        <a href="#task-health-exchange" data-toggle="tab" onclick="loadTaskHealthSection()">Task Health <svg width="35" height="25" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M24.5 48C11.2452 48 0.499999 37.2548 0.5 24C13.7548 24 24.5 34.7452 24.5 48Z" fill="#E748F5" /></svg></a>
                                    </li>
                                @endcan
                            @endif

                            @if($user['user_type_fk'] == 184 )
                                <li><a href="#task-section" data-toggle="tab" onclick="getTaskList(1)">Task Section</a></li>

                                @can('sms-log-list')
                                <li><a href="#sms-logs-section" data-toggle="tab" onClick="smsLogs(1)">SMS Logs</a>
                                </li>
                                @endcan
                                <li><a href="#appointment-section" onclick="loadAppointmentsSection(1)" data-toggle="tab">Appointment Section </a>
                                </li>
                                ...
                                <li><a href="#patient-custom-data" data-toggle="tab">Attribute</a>
                                </li>
                                @endcan
                                ...
                                @if($record->alaycare_id !="")
                                    ...
                                    <li>
                                        @if($record->type =='Caregiver')
                                        <a href="#alaycare" data-toggle="tab" onClick="getAlyacareEmployeeDemographic()" title="Alaycare" alt="Alaycare">AlayaCare</a>
                                        @endif
                                        @if($record->type =='Patient')
                                        <a href="#alaycare" data-toggle="tab" onClick="getAlyacareEmployeeSchedular()" title="Alaycare" alt="Alaycare">AlayaCare</a>
                                        @endif
                                ...
                                @if(isset($agencyDetails->robort_status) && $agencyDetails->robort_status ==1)
                                    @if($record->externalId != "")
                                        ...
                                        <li>
                                            <a href="#robort" data-toggle="tab" onClick="getRemoteBasicDetails()">Remote Focus <img src="{{ asset('/img/emmacare.png')}}" title="Remote Focus" alt="HHA" style="height: 25px; width: 25px;"></a>
                            ...
                            <li><a href="#mq_order_patient" onclick="mdOrders()" data-toggle="tab">MD Order</a>
                            </li>

                            @can('payment-log')
                            <li><a href="#payment_section" onclick="getPaymentData()" data-toggle="tab">Payment Log</a></li>
                            @endcan
                            @if(strtolower($record->type) == 'patient')
                                @can('resolution-log')
                                    <li><a href="#resolution_log_section" onclick="loadResolutionData(1)" data-toggle="tab"> Chart Resolution</a></li>
                                @endcan
                            ...
                            @can('ai-call-logs')
                            @if($record->type == 'Caregiver')
                            <li><a href="#ai-call-logs-section" data-toggle="tab" onclick="loadPatientAiCallLogs()"> AI Call Logs</a></li>
                            @endif
                            @endcan
                            @endif
                            ...
                            @if(auth()->user()->agency_fk == "")
                            <li>
                                <a href="#call-details-section" data-toggle="tab" onclick="loadCallDetailsTabSection()"> Call Details</a>
                            </li>
                            @endif
                            {{-- <li><a href="#patient-linked-files-section" data-toggle="tab" onclick="loadPatientLinkedFiles()"><i class="fa fa-paperclip"></i> Linked Files</a></li> --}}
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content left-section-tab-content">
                            <div class="tab-pane active" id="document-section">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <?php if ($user['user_type_fk'] == 184 || ($user['user_type_fk'] == 2 || $user['user_type_fk'] == 6)) { ?>
                                        @if($userAddDocumentFlag == 1)
                                            <p class="mb-0 tx-13">
                                                @if($user['user_type_fk'] == 184)
                                                <a class="pull-right btn btn-primary btn-sm d-none d-md-block ml-2"  onclick="loadDocumentAjaxList()"><i class="mdi mdi-refresh"></i>
                                                    Refresh
                                                </a>
                                                @endif
                                            <a data-toggle="modal" class="pull-right btn btn-info btn-sm d-none d-md-block" data-target="#exampleModal-5" data-whatever="@mdo" onclick="viewServices();requestsServices();loadDocumentChooseUser();"><i class="mdi mdi-plus"></i>
                                                Add</a>
                                                ...
                                                <table id="" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="white-space:nowrap">Requested Id</th>
                                                            <th style="white-space:nowrap">Attachment</th>
                                                            <th style="white-space:nowrap">Attachment Service</th>
                                                            <th style="white-space:nowrap">Document Completion Date</th>
                            ...
                            <div class="tab-pane" id="hha-exchange">
                                ...
                                <div class="right-section-main">
                                    <ul class="nav nav-tabs tabs-right sideways right-section-ul">
                                        ...
                                        @if ($record->hha_id != '' || $record->link_hha_caregiver != '')
                                        <li class="active"><a href="#hha-caregiver-demographic" onclick="getHHADemographic()"
                                                data-toggle="tab">Demographic Details</a></li>
                                        <li class=""><a role="tab" href="#hha-calender-section" data-toggle="tab" onclick="loadCalender()">Calendar</a>
                                        </li>
                                        <li class=""><a role="tab" href="#hha-caregiver-notes" onclick="refreshHHA()" data-toggle="tab"> Notes</a></li>
                                        <li class=""><a role="tab" href="#hha-caregiver-medical" onclick="getMedicalalList()"
                                                data-toggle="tab">Medical</a></li>
                                        <li class=""><a role="tab" href="#hha-caregiver-other-compliance" onclick="refreshOtherCompliance()"
                                                data-toggle="tab">Other Compliance</a></li>
                                        @endif
                                        @endif
                                        @if($user['user_type_fk'] == 184)
                                        @if (isset($agencyDetails->enable_hha) && $agencyDetails->enable_hha == 1)
                                        ...
                                        <li class="active"><a role="tab" class="active" href="#hha-caregiver-demographic" onclick="getHHADemographic()"
                                                data-toggle="tab">Demographic Details</a></li>
                                        @endcan
                                        ...
                                        <li class=""><a role="tab" href="#hha-caregiver-avaibility" onclick="getCargiverAvaibility()"
                                                data-toggle="tab">Availability</a>
                                        </li>
                                        @endcan
                                        @can('hha-calendar-notes')
                                        <li class=""><a role="tab" href="#hha-caregiver-notes" onclick="refreshHHA()"
                                                data-toggle="tab">Notes</a>
                                        </li>
                                        @endcan
                                        @can('hha-calendar-inservice')
                                        <li class=""><a role="tab" href="#hha-caregiver-inservice" onclick="getInService()"
                                        ...
                                        <li class=""><a role="tab" href="#hha-caregiver-document-section" data-toggle="tab" onclick="refreshDocumentData()">Document</a>
                                        </li>
                                        @endcan
                                        @can('hha-caregiver-preferences')
                                        <li class=""><a role="tab" href="#hha-caregiver-preferences-section" data-toggle="tab" onclick="refreshCaregiverPreferencesData()">Preferences</a>
                                        </li>
                                        @endcan
                                        ...
                                        @if ($record->link_hha_patient != '' && $record->link_hha_patient != 0 && strtolower($record->type) =='patient')
                                            @can('hha-patient-demographic')

                                            <li class="active "><a role="tab" href="#hha-demographic-details" onclick="getHHADemographicDetails()"
                                                    data-toggle="tab">Demographic Details</a></li>
                                            @endcan
                                            @can('hha-sync-appointment-calendar')
                                            <li class=""><a role="tab" href="#hha-calender-section" data-toggle="tab" onclick="loadCalender()">Calendar</a>
                                            ...
                                            <li class=""><a role="tab" href="#hha-get-patient-authorization-info-details"
                                                    onclick="GetPatientAuthorizationInfo()" data-toggle="tab">Authorization Info Section</a></li>
                                            @endcan


                                            @can('hha-get-patient-notes')
                                            <li class=""><a role="tab" href="#hha-get-patient-notes" onclick="GetPatientNotes()"
                                                    data-toggle="tab">Notes</a></li>
                                            @endcan

                                            @can('hha-get-patient-clinics')
                                            <li class=""><a role="tab" href="#hha-get-patient-clinics" onclick="GetPatientClinics()" data-toggle="tab">Clinical</a></li>
                                            @endcan

                                            @can('hha-get-patient-poc-info')
                                            <li class=""><a role="tab" href="#hha-get-patient-poc-info" onclick="GetPatientPOCInfo()" data-toggle="tab">POC Info</a></li>
                                            @endcan

                                            @can('hha-get-patient-changes-v2')
                                            <li class=""><a role="tab" href="#hha-get-patient-v2-changes-section" onclick="GetPatientChangesV2Info()" data-toggle="tab">Changes V2</a></li>
                                            @endcan

                                            @can('hha-patient-document')
                                            <li class=""><a role="tab" href="#hha-patient-document-section" data-toggle="tab" onclick="refreshPatientDocumentData()">Document</a>
                                            </li>
                                            @endcan
                                            @can('hha-patient-contract')
                                            <li class=""><a role="tab" href="#hha-patient-contract-section" data-toggle="tab" onclick="refreshPatientContactData()">Contract</a>
                                            </li>
                                            @endcan
                                            @can('hha-patient-discipline')
                                            <li class=""><a role="tab" href="#hha-patient-discipline-section" data-toggle="tab" onclick="refreshPatientDisciplineData()">Discipline</a>
                                            </li>
                                            @endcan
                                            @can('hha-patient-preferences')
                                            <li class=""><a role="tab" href="#hha-patient-preferences-section" data-toggle="tab" onclick="refreshPatientPreferencesData()">Preferences</a>
                                            </li>
                                            @endcan
                            ...
                            <div class="tab-pane" id="appointment-section">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <p class="mb-0 tx-13 d-flex" style="gap:6px;">
                                        @can('ai-call-logs')
                                        @if(auth()->user()->agency_fk == "")
                                        @if($record->type == 'Caregiver')
                                        ...
                                        @endif
                                        @endcan
                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#exampleModal-4" data-whatever="@mdo" class="pull-right btn btn-info btn-sm d-none d-md-block addAppointment"><i class="mdi mdi-plus"></i> Add</a>
                                    </p>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12" style="justify-content:center;">
                            <img src="{{ asset('/ajax-loader.gif') }}" alt="loader" id="loadertagLogs" style="display: none; ">
                            <div id="logList"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="forms-sample" enctype="multipart/form-data" action="<?php echo URL::to('/patient/appointment-schedule'); ?>" name="adduser" method="post" id="appointmentForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="" class="col-form-label">Services<span class="error mt-2">*</span></label>
                        <select class="js-example-basic-multiple w-100" multiple="multiple" name="service_id[]" id="service_eid">
                            ...
                            <option value="{{$ks->id}}" @if(in_array($ks->id,$serviceArr)) selected @endif>{{ $ks->name }}</option>
                            @endif
                            @endforeach
                            @endif
                        </select>
...
<button type="button" class="btn btn-success btn-sm px-4 mr-2" id="commons_flag"><span class="spinner-border spinner-border-sm d-none" id="create-change-status-history" aria-hidden="true"></span> Save</button>
...
@if(isset($portalFields) && count($portalFields) > 0)
    <div class="modal fade" id="portalFieldEditModal" tabindex="-1" aria-labelledby="portalFieldModalLabel" aria-hidden="true">
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            var extra = res.is_existing
                ...
                : '<small class="d-block mt-1 text-muted">New log #' + res.log_id + ' created and fired</small>';
            $('#apptAddCallFeedback')
                .attr('class', 'alert ' + cls + ' py-2 px-3')
                .html('<i class="fa ' + icon + ' mr-1"></i>' + res.message + extra)
                .show();
            if (res.status) {
                btn.prop('disabled', true).html('<i class="fa fa-check mr-1"></i> Done');
                setTimeout(function() { $('#appointmentAddCallModal').modal('hide'); }, 2000);
            } else {
        ...
        error: function(jqXHR) {
            ...
            $('#apptAddCallFeedback')
                .attr('class', 'alert alert-danger py-2 px-3')
...
function loadPatientLinkedFiles() {
    ...
    $.get('/file-manager/patient/' + patientId + '/files', function (res) {
        ...
        $.each(res.data, function (i, f) {
            html += '<tr>'
                + '<td>' + $('<div>').text(f.file_name).html() + (f.is_archived ? ' <span class="label label-default" style="font-size:10px;">Archived</span>' : '') + '</td>'
                + '<td>' + f.file_type + '</td>'
                + '<td>' + f.file_size + '</td>'
                + '<td>' + f.linked_at + '</td>'
                + '<td style="white-space:nowrap;">'
                + (f.is_previewable ? '<button class="btn btn-xs btn-info mr-1" title="Preview" onclick="previewLinkedFile(' + f.file_id + ', \'' + f.agency_id + '\')"><i class="fa fa-eye"></i></button>' : '')
                + '<a href="' + f.download_url + '" class="btn btn-xs btn-success mr-1" title="Download"><i class="fa fa-download"></i></a>'
                + '<button class="btn btn-xs btn-danger" title="Unlink" onclick="unlinkPatientFile(' + f.file_id + ',' + patientId + ')"><i class="fa fa-unlink"></i></button>'
                + '</td>'
                + '</tr>';
        });
        html += '</tbody></table>';
...
<script>
    ...
    function getTimeSearchForAgency13022025() {
        var location_id = $('#location_eid').val();
    ...
    function getOtherMedicalResult(agencyId, val) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#hha_document_complience_id').val(null).trigger('change');
                if (res != 0) {
...
<script>
    ...
    var empId = $('#alayacare_existing_emp_id').val();
    var empName = $('#alayacare_existing_name').val();
...
<script>
    ...
    if(agencyFks ==""){
        ...
        function extractTags(content) {
            ...
            var match = matches ? matches.map(match => ({
                name: match[0]
            })) : [];
    ...
    function scheduleAppointmentSelected() {
        $('#date_id').val('');
        $('#location_id').val('');
        $('#timeid').val('');
        $('#date_time_div').html('');
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (response.length != 0) {
                        ...
                        $('#hhaAppendCId').html('<tr><td colspan="7">No record available</td></tr>')
                    }
...
<script>
    ...
    function alaycareClientFunction() {
        ...
        $("#hha_alaycare_client_id").tokenInput(urlToken, {
            ...
            tokenLimit: 1,
            zindex: 9999,
            prePopulate: empClientId !== "" && empClientName !== "" ? [{
                id: empClientId,
                name: empClientName + ' ( ' + empClientId + ' ) '
            }] : [],
            onAdd: function(item) {
    ...
    $('#update-alaycare-client-id').click(function() {
        var alaycareId = $('#alayacare_existing_client_id').val();
        ...
        if (cnt == 1) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('.token-input-list').remove();
                    var fullName = res.data[0].alaycare_name;
                    var patientId = res
                    empClientId = res.data[0].alaycare_id;
    ...
    $('body').on('click','#show_new_other_compliance_need',function($join){
