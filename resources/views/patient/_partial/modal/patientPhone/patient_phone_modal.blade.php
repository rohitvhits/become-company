            ...
            <form class="forms-sample" enctype="multipart/form-data" name="adduser" method="post" id="phone_form_submit_id">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Phone"  data-inputmask-alias="(999) 999-9999" id="record_phn_id" onkeypress="return isNumber(event)" name="record_phn" value="" maxlength="15">
