            ...
            <form class="forms-sample" enctype="multipart/form-data" name="adduser" method="post" id="mobile_form_submit_id">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Mobile" id="record_mob_id"  data-inputmask-alias="(999) 999-9999" onkeypress="return isNumber(event)" name="mobile" value="" maxlength="15">
