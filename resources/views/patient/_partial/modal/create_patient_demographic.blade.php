                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label">First Name<span class="text-danger mt-2">*</span></label>
                                    ...
                                    <input type="text" class="form-control charCls form-control-sm" placeholder="Enter First Name " id="agency_name" name="first_name" value="<?php echo old('first_name'); ?>" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label">Last Name<span class="text-danger mt-2">*</span></label>
                                    ...
                                    <input type="text" class="form-control charCls form-control-sm" placeholder="Enter Last Name " id="last_name_id" name="last_name" value="<?php echo old('last_name'); ?>" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label">Date of Birth<span class="text-danger mt-2">*</span></label>
                                    ...
                                    <input type="date" class="form-control bill_date form-control-sm " autocomplete="off" placeholder="Select Date of Birth" id="dob_id" name="dob" value="<?php echo old('dob'); ?>"  onBlur="getExistingUserData()"  min="1000-01-01" max="9999-12-31">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label">Mobile<span class="text-danger mt-2">*</span></label>
                                    ...
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter Mobile" id="mobile" data-inputmask-alias="(999) 999-9999" onkeypress="return isNumber(event)" name="mobile" value="<?php echo old('mobile'); ?>" maxlength="15">
