            ...
            <form class="forms-sample" enctype="multipart/form-data" action="" name="adduser" method="post" id="esignMoveDocumentForm">
                <div class="modal-body p-4" style="background-color:white">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="form-group row">
                                <label for="esign_request_service_id" class="font-weight-semibold">
                                    Request Services
                                    
                                </label>
                                <select class="form-control select2 w-100" name="esign_request_service_id[]" id="esign_request_service_id">
                                    <option value="">Select Request Service</option>
                                </select>
                                <span id="esign_request_service_id_error" class="error mt-2 text-danger d-block"></span>
                            </div>
                            <div class="form-group row">
                                <label for="esign_document_service_id" class="font-weight-semibold">
                                    Services
                                    <span class="text-danger">*</span>
                                </label>
                                <select class="js-example-basic-multiple w-100" multiple="multiple" name="esign_document_service_id[]" id="esign_document_service_id">
                                    <option value="">Select Service</option>
                                </select>
                                <span id="esign_document_service_id_error" class="error mt-2 text-danger d-block"></span>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row @if($auth->agency_fk == '') @else hide @endif">
                                <div class="form-check form-check-primary mb-2">
                                    <label class="form-check-label">
                                        ...
                                        <i class="input-helper"></i> Insurance Eligibility<br>
                ...
                <div class="modal-footer border-top-0 bg-light">
                    <div class="d-flex justify-content-end align-items-center w-100">
                        <button type="button" class="btn btn-success btn-sm px-4 mr-2" id="esignMoveDocumentSave">
