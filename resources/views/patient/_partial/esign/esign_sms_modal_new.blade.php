...
<div class="modal fade" id="sendSMSEsignNew" aria-modal="true" role="dialog" style="padding-right: 17px; display: none;">
            ...
            <form action="" id="sms_esign_new" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-10">
                            <input type="text" name="email" class="form-control" id="email_new" placeholder="Enter Email" value="<?php echo $record->email; ?>">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="mobile" class="form-control" id="mobile_no_id_caregiver_new" placeholder="Enter Mobile" value="<?php echo $record->mobile; ?>">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="getSendSMSSubmitNew()">Send Document to Sign</button>
                </div>
            </form>
        </div>
    </div>
