            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="email" id="document_email"  class="form-control" value="@if(isset($agencyDetails) && !empty($agencyDetails)){{ $agencyDetails->document_email_notification }}@endif" rows="4">@if(isset($agencyDetails) && !empty($agencyDetails)){{ $agencyDetails->document_email_notification }}@endif</textarea>
                        <span id="document_email_error" class="error"></span>
                    </div>
                    <div class="form-check form-check-primary mb-0 mt-2">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" id="send_back_to_agency_mail" name="send_back_to_agency_mail" value="1">
                            <i class="input-helper"></i> Send Back to Agency
                        </label>
                    </div>
                </div>
