...
<script src="{{ asset('assets/modulejs/patient_robort.js') }}?time={{ time()}}"></script>
@endif

<script src="{{ asset('assets/modulejs/patient_alayacare.js') }}?time={{ time()}}"></script>
...
<script src="{{ asset('assets/modulejs/esign_module_new.js')}}?time={{ time()}}"></script>
<script src="{{ asset('assets/modulejs/esign_streamlined.js')}}?time={{ time()}}"></script>
...
<script src="{{ asset('assets/modulejs/service_requested_by_patient.js')}}?time={{ time()}}"></script>
...
<script type="text/javascript" src="{{ asset('assets/modulejs/mdOrder/mdOrder.js')}}?time={{ env('timestamp')}}">
</script>
...
<script>
    ...
    var TASK_AJAX_LIST = "{{url('tasks/task-list/')}}/";
    var TASK_LIST = TASK_AJAX_LIST;
    ...
    var _HHA_CAREGIVER_OTHER_COMPLIANCE_LIST = "{{ url('hha/hha-other-compliances/all-other-compliance-list') }}";
    ...
    var _IMAGICK_TEMP_PDF = "{{ url('imagick-temp-pdf') }}";
...
<script type="text/javascript" src="{{ asset('assets/modulejs/telehealth_schedule.js')}}?time={{ env('timestamp')}}">
</script>
