...
<div class="main-panel main-page-box">
    ...
    <div class="content-wrapper content-wrapper-box">
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">HHA Due Medical</h5>
                                        ...
                                        <div class="form-group cust-select-box">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <select name="employment_type" id="employment_type" class="form-control" placeHolder="Select Employeement Type">
     ...
     <script type="text/javascript">
        ...
        $("#filter-btn").click(function() {
         ...
         function hhaAppoitnemtList(page=1) {
            ...
            $('.location-wise-data-loader').attr('style', 'display:flex');
             $.ajax({
                    url: "{{ url('hha/due-medical-report/due-medical-report-ajax') }}?page=" + page,
                    type: "GET",
                    data: {
                        'agency_fk': agency_fk,
                        'fname': fname,
        ...
        function exportCsv(){
            ...
            var link ="{{ url('hha/due-medical-report/due-medical-report-export-csv') }}?agency_fk="+agency_fk+"&fname="+fname+"&code="+code+"&medical_name="+medical_name+"&due_date="+due_date+"&status="+status+"&caregiver_status="+caregiver_status+"&date_perform="+date_perform+"&hire_date="+hire_date+"&employment_type="+employment_type+"&office_id="+office_id;
        ...
        function addAppointment() {
            ...
            if (checked == false) {
                ...
                commonAddAppointment(final_array,1);
            }
        }
        ...
        function singleDataAppointment(id) {
            var final_array = [];
            final_array.push(id);
            commonAddAppointment(final_array);
        }

        function commonAddAppointment(data,flag=0){
            var msg = "You want to create new appointment?";
            if(flag ==1){
                msg = "You want to create bulk appointments?";
            }
            $.confirm({
                title: "Are you sure?",
                content:msg,
                ...
                buttons: {
                    submit: {
                        ...
                        action: function () {
                            $.ajax({
                                url: "{{ url('hha/due-medical-report/add-appointment-patient') }}",
                                type: "post",
                                data: {
                                    'ids': data,
                                    '_token': '{{ csrf_token() }}',
