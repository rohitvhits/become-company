...
<div class="main-panel main-page-box">
    ...
    <div class="content-wrapper content-wrapper-box">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">VNS Procedure List</h5>
            <div class="page-rightbtns cust-page-rightbtns">
                <div>
                    @can('add-vns-procedure')
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal-add-vns-procedure" id="link-add-procedure" data-whatever="@mdo" onclick="resetAddProcedure()" class="btn btn-primary cust-right-btn"><i
                            class="mdi mdi-plus"></i>Add VNS Procedure</a>
                    @endcan
...
@include('vns_procedure._partial.create_procedure_modal')
@include('vns_procedure._partial.edit_procedure_modal')

@include('include/footer')

<script>
   var _LOAD_DATA_URL = "{{ url('vns-procedure/data/list')}}";
   var _CSRF_TOKEN ="{{ csrf_token()}}";
   var _DELETE_VNS_PROCEDURE="{{ url('vns-procedure')}}";
   var _SAVE_PROCEDURE="{{ url('vns-procedure/save')}}";
   var _EDIT_PROCEDURE="{{ url('vns-procedure/edit')}}";
   var _UPDATE_PROCEDURE="{{ url('vns-procedure/update')}}";
   var _EXPORT_CSV="{{ url('vns-procedure/export-csv')}}";
</script>

<script src="{{ asset('assets/modulejs/vns_procedure/vns_procedure.js')}}?time={{ env('timestamp') }}"></script>
