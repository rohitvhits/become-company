...
<div class="container-fluid">
    <div class="content-wrapper">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Create Notification Email</h5>
        </div>
        <div class="row">
            <div class="col-md-12">
                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                            <form class="user" action="{{ route('notification-email.store') }}" method="POST"
                                ...
                                <div class="card-body  pl-0">
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control form-control-user col-sm-11" rows="4" cols="50" id="message" name="message" ></textarea>
