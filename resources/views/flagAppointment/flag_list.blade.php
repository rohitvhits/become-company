...
<div class="main-panel">
                                ...
                                <div class="tabs--container">
                                    <div class="tabs js-tabs">
                                        <div class="tabs--scrollable">
                                            <div class="tabs__toggle-group">
                                                <div class="tabs__toggle tabs__toggle--active">
                                                    <a class="nav-link active" href="#appointment-section" data-toggle="tab" onclick="loadAppointmentFlagList(1)">Appointment</a>
                                                </div>
                                        ...
                                        <div class="tabs__tabs-group">
                                            <div class="tabs__tab">
                                                @include('flagAppointment/_partial/appointment_section')
                                            </div>
                                            <div class="tabs__tab">
                                                @include('flagAppointment/_partial/document_section')
                                            </div>
                                            @if(Auth()->user()->agency_fk =="")
                                            <div class="tabs__tab">
                                                @include('flagAppointment/_partial/task_section')
                                            </div>
                                            @endif
                                            <div class="tabs__tab">
                                                @include('flagAppointment/_partial/notes_section')
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        var _FLAG_APPOINTMENT_LIST = "{{ url('flag-appointment-ajax-list') }}";
        var _FLAG_DOC_LIST = "{{ url('flag-doc-ajax-list') }}";
        var _FLAG_TASK_LIST = "{{ url('flag-task-ajax-list') }}";
        var _FLAG_NOTES_LIST = "{{ url('flag-notes-ajax-list') }}";
        var _SEARCH_PATIENT_LIST = "{{ url('search-nybest-user') }}";
        var _CSRF_TOKEN = "{{ csrf_token() }}";
        var _FLAG_MARK_LIST = "{{ url('mark-flag-read') }}";
    </script>
