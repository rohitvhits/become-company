<div class="modal fade" id="exampleModal-alayacare-emp-due-skill" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Discipline <span class="error mt-2">*</span></label>
                            <div class="col-sm-9">
            ...
            <div class="modal-footer border-top-0 bg-light">
                <div class="d-flex justify-content-end align-items-center w-100">
                    ...
                    <span class="spinner-border spinner-border-sm d-none" id="create-alayacare-due-skill" aria-hidden="true"></span>
