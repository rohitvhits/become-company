        ...
        <div class="content-wrapper">
          <div class="card">
          	  <div class="row list-name">
				   <div class="col-sm-5" > <h4 class="card-title">Filed Report List ({{$query->total()}})</h4></div>
				   ...
				   <!--<a href="javascript:void(0)" onclick="getArchive()" class="btn btn-info btn-fw btn-sm pull-right"><i class="mdi mdi-reload"></i>Patient Archive</a>-->
					<a href="<?php echo URL::to('/');?>/filed-report-export?name=<?php echo $name;?>&agency_fk=<?php echo $agency_fk;?>&email=<?php echo $email;?>&phone=<?php echo $phone;?>&emcuser=<?php echo $emcuser;?>&medicaid_issue=<?php echo $medicaid_issue;?>&record_form=<?php echo $record_form;?>&filed_date=<?php echo $filed_date;?>&patient_status=<?php echo $patient_status;?>&created_date=<?php echo $created_date;?>" class="btn btn-success pull-right btn-fw btn-sm" id="test_record" ><i class="mdi mdi-file-export"></i>Export</a>
				   	<a href="<?php echo URL::to("/"); ?>/filed-report" class="btn btn-danger pull-right btn-fw btn-sm"><i class="mdi mdi-reload"></i> Reset</a>
		                    ...
		                    <table id="order-listing1" class="table table-bordered">
		                      <thead>
								...
								<form method="get" action="" >
									...
									<th>
										<input type="text" name="filed_date" class="form-control datepickernn" value="@if(isset($filed_date) && $filed_date !='') {{$filed_date}} @endif">
									</th>
									...
									<td><input autocomplete="off" type="text" name="created_date" class="form-control datepicker_date" value="<?php if($created_date !='') { echo $created_date;} ?>"></td>
		                      		<td> 
