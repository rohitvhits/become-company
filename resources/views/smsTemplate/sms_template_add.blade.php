          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
				  ...
				  <form method='post' action='<?php echo URL::to('/sms-template/insert'); ?>' name="addPhysician" role="form" id="addPhysician" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
					
                        <div class="form-group">
                         <label for="FirstName">Name <span class="error">*</span></label>
                          <div class="col-sm-9">
								<input type="text" class="form-control" id="FirstName"  name="name" value="<?php echo old('name') ?>">
						...
						<div class="form-group">
                         <label for="FirstName">Message<span class="error">*</span></label>
                          <div class="col-sm-9">
								<textarea class="form-control" id="FirstNamel" rows="10" name="message"><?php echo old('message') ?></textarea>
