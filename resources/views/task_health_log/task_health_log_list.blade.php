 ...
 <div class="main-panel">
     <div class="content-wrapper">
         <div class="page-title-main">
             <h5 class="mb-0 font-weight-bold">Task Health Log List</h5>
         </div>
                                 ...
                                 <div class="search-inner">
                                     <div>
                                         <input type="button" name="search"
                                             class="btn btn-primary search-btn1 searchAppoinment" onclick="loadTaskHealthLogList(1);" id="search-data"
                                             value="Search">
                                             <a href="<?php echo URL::to('/'); ?>/task-health-log" class="btn btn-light btn-rounded btn-fw btn-sm ml-1"><i
...
@include('task_health_log/_partial/log_modal')
...
<script>
    var _TASK_HEALTH_LOG_LIST = "{{ url('task-health-log-ajax-list') }}";
    var _TASK_HEALTH_LOG = '{{ url("/task-health-log") }}';
    var _TASK_HEALTH_LOG_BY_ID = '{{ url("/get-task-health-log-by-id") }}';
</script>
<script src="{{ asset('assets/modulejs/task_health_log/task_health_log.js')}}?time={{ time()}}"></script>
