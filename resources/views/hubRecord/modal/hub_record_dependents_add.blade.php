    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="margin-top:10px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add dependents</h4>
            ...
            <form action="javascript:voide(0)" method="POST" id="add_new_hub">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group  mb-2">
                                ...
                                <input type="text" class="form-control charCls form-control-sm"
                                    placeholder="Enter First Name " id="dep_first_name" name="first_name"
                                    value="">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control charCls form-control-sm"
                                    placeholder="Enter Last Name " id="dep_last_name_id" name="last_name"
                        ...
                        <div class="col-md-4">
                            <div class="form-group  mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter Email "
                                    id="dep_email" name="email" value="<?php echo old('email'); ?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter Mobile"
                                    id="dep_mobile_no" onkeypress="return isNumber(event)" name="mobile"
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter Phone"
                                    id="dep_phone" onkeypress="return isNumber(event)" name="phone"
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter SSN"
                                    id="dep_ssn" name="ssn" value="<?php echo old('ssn'); ?>">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="saveHub">Save dependents</button>
