<div class="modal fade modal-container" id="task_due_date_modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Due Dute <span class="" style="font-size: 18px;"><span id="task_id"></span></h4>
            ...
            <div class="modal-body position-relative">
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group date" id="task_due_date_id_date">
                            <input type="text" id="task_due_date_id" class="form-control date_input" required />
                        ...
                        <span id="task_due_date_id_error" class="error"></span>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="changeDate();">Update</button>
