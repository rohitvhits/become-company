<div class="modal fade" id="hub-languages" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Change Language</h5>
                <button type="button" class="close" id="close_hub_language" data-dismiss="modal" aria-label="Close">
            ...
            <form class="forms-sample" enctype="multipart/form-data" name="adduser" method="post" id="language_form_submit_id">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Language<span style="color:red">*</span>:</label>
                            <select name="hub_language_id" class="form-control" id="hub_language_id">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="updateHubLanguage()" class="btn btn-success">Save</button>
