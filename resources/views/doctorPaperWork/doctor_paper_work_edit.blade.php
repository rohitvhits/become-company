...
<div class="modal-body">
							<form class="form-sample" id="doctor_paper_workupdate" name="adduser" method="post" >
                    			<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
								<input type="hidden" name="id" id="doc_update_id" value="{{$doctor_paper_list->id}}">
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group row">
											<label class="col-sm-3 col-form-label">EMC Rep <span class="text-danger">*</span></label>
											<div class="col-sm-9">
												...
												<span  id="rep_id_edit_error" class="error mt-2 text-danger"><?php echo $errors->add_record->first('rep_id'); ?></span>
                        ...
                        <div class="modal-footer">
                          <button type="button" id="notes_submit_update" class="btn btn-success" >Submit</button>
...
$(":input").inputmask();
					$('#notes_submit_update').click(function(e){
						var names = $('#doc_agency_name_edit').val();
						var emd_id = $('#rep_id_edit').val();
						$('#doc_name_error').html("");
						$('#rep_id_edit_error').html("");
						var cnt =0;
						if(names.trim() ==''){
						...
						/*if(emd_id ==''){
							$('#rep_id_edit_error').html("Required");
							cnt =1;
						}*/
						if(cnt ==1){
							return false;
					...
					function addMoreEdit(){
						...
						var urlhemlt = '<div class="copy_idsn row" id="'+uniqid+'">'
										...
										+'</div>'
										+'<div class="col-md-2" style="margin-left:6%">'
											+'<a class="btn btn-info" onclick="getRemoveNew('+uniqid+')" id="lastIdNewEdit"><i class="fa fa-minus"></i></a>'
										+'</div></div>';
