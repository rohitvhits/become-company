        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Add Location Schedule</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    <form class="form-sample" name="addTelehealthSchedule" id="addTelehealthSchedule" method="post">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter Schedule Title">
                                            <span id="title_error" class="error mt-2"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="telehealth_config_type" id="telehealth_config_type" class="form-control">
                                                <option value="">Select Telehealth Configuration Type</option>
                                                <option value="patient">Patient</option>
                                                <option value="caregiver">Caregiver</option>
                                            </select>
                                            <span id="telehealth_config_type_error" class="error mt-2"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <span id="location_id_error" class="error mt-2"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <span id="day_error" class="error mt-2"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="time" class="form-control" placeholder="Enter Start Time" id="start_time" name="start_time" value="">
                                            <span id="start_error" class="error mt-2"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="time" class="form-control" placeholder="Enter End Time" id="end_time" name="end_time">
                                            <span id="end_time_error" class="error mt-2"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Time Slot (In Minutes)<span
                                            class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="slot" name="slot" value="" onkeypress="return isNumber(event)">
                                            <span id="slot_error" class="error mt-2"><?php echo $errors->add_agency->first('slot'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <div class="text-center mt-0 mb-0" id="loader_add" style="display:none"><i class="fa fa-spinner fa-spin fa-2x mt-2 mb-0"></i></div>
                            <button type="button" class="btn btn-primary mr-2 btn-sm" onclick="addTeleLocationSchedule()">Save</button>
