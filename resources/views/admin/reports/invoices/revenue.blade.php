    ...
    <div class="content-wrapper invoice-module-wrapper">
        <div class="page-title-main">
            ...
            <div class="page-rightbtns">
                ...
                <a href="{{ route('admin.reports.invoices.revenue', ['export' => 'csv']) }}" class="btn btn-success btn-sm invoice-action-btn btn-icon-text"><i class="mdi mdi-download"></i>Export CSV</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card admin-invoice-stats">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.reports.invoices.revenue') }}" class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('admin.reports.invoices.revenue') }}" class="btn btn-secondary btn-sm invoice-action-btn">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">${{ number_format($month->average_value, 2) }}</td>
                                        </tr>
                                        @empty
                                        <tr>
            ...
            <div class="col-md-12">
                <div class="card chart-card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="chart-toggle-group" id="agency-revenue-toggle-group">
                            <button type="button" class="chart-toggle-btn active" data-chart="agency-revenue-chart" data-container="agency-revenue-chart-container">
                                <i class="mdi mdi-chart-bar"></i>
                                Chart
                            </button>
                            <button type="button" class="chart-toggle-btn" data-table="agency-revenue-table" data-container="agency-revenue-table-container">
                                <i class="mdi mdi-table"></i>
                                Table
                            </button>
                        </div>
                    ...
                    <div class="card-body">
                        <!-- Chart View -->
                        <div id="agency-revenue-chart-container">
                            <canvas id="agencyRevenueChart" width="400" height="250"></canvas>
                        </div>

                        <!-- Table View -->
                        <div id="agency-revenue-table-container" style="display: none;">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @forelse($agencyRevenue as $agency)
                                        <tr>
                                            <td>{{ $agency->agency_name }}</td>
                                            <td class="text-right font-weight-bold">${{ number_format($agency->revenue, 2) }}</td>
                                            <td class="text-center">{{ $agency->invoice_count }}</td>
                                            <td class="text-right">${{ number_format($agency->average_value, 2) }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td colspan="4" class="text-center text-muted">No agency revenue data available</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (monthlyRevenueCtx) {
        ...
        const monthlyInvoices = monthlyData.map(m => m.invoice_count);
    ...
    @if($agencyRevenue->count() > 0)
    // Agency Revenue Horizontal Bar Chart
    const agencyRevenueCtx = document.getElementById('agencyRevenueChart');
    if (agencyRevenueCtx) {
        const agencyData = @json($agencyRevenue->take(10));
        const agencyLabels = agencyData.map(a => a.agency_name);
        const agencyRevenues = agencyData.map(a => a.revenue);

        new Chart(agencyRevenueCtx, {
            type: 'bar',
            data: {
                labels: agencyLabels,
                datasets: [{
