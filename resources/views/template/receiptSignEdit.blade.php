 ...
 <div class="main-panel">
                             ...
                             <div class="card-body">
                                 <form method='post' action='<?php echo URL::to('/insertReceiptSigner'); ?>' name="addPhysician" role="form"
                                     ...
                                     <div class="signer-info-strip">
                                         ...
                                         <div>
                                             Signers: <strong><span id="signer-count">{{ count($oldRecordById) }}</span></strong>
                                                ...
                                                <div class="col-md-12 row">
                                                    <div class="col-md-6">
                                                         <div class="form-group">
                                                             <label><span class="signer-num">{{ $cnt + 1 }}</span> Signer Receipt</label>

                                                             <select name="dropDown[]" class="form-control" onchange="OfficeStaff('{{ $cnt}}', this.value,'selected');">
                                                                 <option value="">Select Signer</option>
                                                                 @if($template_type->lookup_fields =='caregiver')
                                                                 <option value="Caregiver" @if($val->name == 'Caregiver') selected @endif>Caregiver
                                                                 </option>

                                                                  <option value="OfficeStaff" @if($val->name == 'OfficeStaff') selected @endif>User
                                                                 </option>
                                                                 <option value="StampUser" @if($val->name == 'StampUser') selected @endif>Stamp User
                                                                </option>
                                                                 <option value="Other" @if($val->name == 'Other') selected @endif>Other</option>
                                                                  <option value="FormFill" @if($val->name == 'FormFill') selected @endif>Form Fill</option>
                                                                 <option value="Sign" @if($val->name == 'Sign') selected @endif>Sign</option>
                                                                <option value="Stamp" @if($val->name == 'Stamp') selected @endif>Stamp</option>
                                                                 @else
                                                                 
                                                                 <option value="Patient" @if($val->name == 'Patient') selected @endif>Patient
                                                                 </option>
                                                                 <option value="SignStamp" @if($val->name == 'SignStamp') selected @endif>Sign & Stamp</option>
                                                                 @endif
                                                     ...
                                                     <div class="col-md-5">
                                                         <div class="office{{ $cnt }}" style="display: {{ !empty($val->user_id) ? 'block' : 'none' }};">
                                                             <div class="form-group">
                                                     ...
                                                     <script>
                                                         $(".searchid{{$cnt}}").tokenInput("{{ url('/searchByUserList')}}", {
                                                            tokenLimit: 1,
                                                            @if(!empty($val->names))
                                                                prePopulate: [{
                                                                    id: {{ $val->id }},
                                                     ...
                                                     <div class="col-md-1" style="margin-bottom:15px;">
                                                         <button class="btn btn-danger btn-sm remove_button"
                                                             title="Remove field" type="button"><i
     ...
     <script type="text/javascript">
         $(document).ready(function() {
             ...
             // Apply restriction on page load for edit mode
             checkSignerLimit();
             ...
             function() {
                     $.getScript("{{ url('assets/jquery.tokeninput.js')}}", function() {
                         var j = 0;
     ...
     <script>
         function getSearch(id) {
             ...
             $(".office" + id + " .searchid" + id).tokenInput("{{ url('searchByUserList')}}", {
                 tokenLimit: 1
             });
         }
     </script>
