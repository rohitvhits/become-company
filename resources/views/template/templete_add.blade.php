...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Template Add</h5>
        </div>
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form method='post' action='<?php echo URL::to('/insertTemplate'); ?>' name="addPhysician" role="form" id="addPhysician" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="FirstName">Template Name <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="FirstName" name="template_name" value="<?php echo old('template_name'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="LastName">Document type <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div id="appointment-form">
                                            <input name="attached_files" value="" id="docufile_imp" type="hidden" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="remark" class="form-control" style="height:150px;"><?php echo old('remark'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="FirstName">Lookup Fields <span class="error">*</span></label>
                                        <div class="col-sm-9 mt-2">
                                        <input onclick="showRelution()" type="radio" name="lookup_field" value="caregiver"> Caregiver
                                        <input onclick="showRelution()" class="radioClass" type="radio" name="lookup_field" value="patient"> Patient
                                        <br><span class="error" id="lookup_error">{{ $errors->template->first('lookup_field') }}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="template_type" id="template_type">
                                                ...
                                                <option value="location" {{ old('template_type') == 'location' ? 'selected' : '' }}>Location</option>
                                                <option value="telehealth" {{ old('template_type') == 'telehealth' ? 'selected' : '' }}>Telehealth</option>
                                            </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="LastName">E-signature <span class="error">*</span></label>
                                        <div class="col-sm-9 mt-2">
                                                <input type="radio" name="esign" value="1" checked> Yes
                                                <input class="radioClass" type="radio" name="esign" value="0"> No
                                                <span class="error" id="vesign_error"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row hide" id="esign_workflow_div">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="esign_workflow" id="esign_workflow">
                                                ...
                                                <option value="form_complete_with_sign">Form Completed with Sign</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="LastName">Checkbox Mark</label>
                                        <div class="col-sm-9 mt-2">
                                            <input type="checkbox" name="checkbox_mark_flag" value="1"> Yes
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6 mt-2">
                                                    <input type="checkbox" name="show_verify_by" value="Y"> Yes
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6 mt-2">
                                                    <input type="checkbox" name="send_caregiver_email" value="Y"> Yes
                            ...
                            <div class="row"> 
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="emailid" name="email_notification"><?php echo old('email_notification') ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 hide" id="resolution_update_id">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="FirstName">Resolution Update</label>
                                        <div class="col-sm-9 mt-2">
                                            <input type="checkbox" name="resolution_update" value="Y"> Yes
                                        </div>
                                    </div>
                                </div>
                            </div><hr>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 mt-2">
                                            <input type="checkbox" name="custom_template" value="1"> Yes
    ...
    <script type="text/javascript">
        ...
        jQuery("div#m-dropzone-one").dropzone({
            maxFiles: 1,
        ...
        $('#addPhysician').submit(function(e) {
            ...
            var lookup_field = $("input[name='lookup_field']:checked").val();
