    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Location Schedule</h4>
                        <form class="form-sample" action='<?php echo URL::to('/location-schedule/update'); ?>' name="adduser" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="day" class="form-control" id="day_id">
                                                ...
                                                <option value="monday" <?php if ($location_schedule->day == 'monday') {
                                                    echo "selected='selected'";
                                                } ?>>Monday</option>
                                                <option value="tuesday" <?php if ($location_schedule->day == 'tuesday') {
                                                    echo "selected='selected'";
                                                } ?>>Tuesday</option>
                                                <option value="wednesday" <?php if ($location_schedule->day == 'wednesday') {
                                                    echo "selected='selected'";
                                                } ?>>Wednesday</option>
                                                <option value="thursday" <?php if ($location_schedule->day == 'thursday') {
                                                    echo "selected='selected'";
                                                } ?>>Thursday</option>
                                                <option value="friday" <?php if ($location_schedule->day == 'friday') {
                                                    echo "selected='selected'";
                                                } ?>>Friday</option>
                                                <option value="saturday" <?php if ($location_schedule->day == 'saturday') {
                                                    echo "selected='selected'";
                                                } ?>>Saturday</option>
                                                <option value="sunday" <?php if ($location_schedule->day == 'sunday') {
                                                    echo "selected='selected'";
                                                } ?>>Sunday</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="time" class="form-control" placeholder="Enter state"
                                                id="state" name="state_time" value="<?php echo $location_schedule->start_time; ?>">
                                            <span id="state_error"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="time" class="form-control" placeholder="Enter City"
                                                id="city" name="end_time" value="<?php echo $location_schedule->end_time; ?>">
                                            <span id="city_error"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="type" class="form-control" placeholder="Enter slot"
                                                ...
                                                value="<?php echo $location_schedule->slot; ?>">
                                            <span id="slot_error"
