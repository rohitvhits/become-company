<div class="modal fade" id="exampleModal-alayacare-client" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body">
                <form class="forms-sample" enctype="multipart/form-data" action='' name="add-appointment" method="post" id="submitId">
                    ...
                    <input type="hidden" name="alaycare-client-id" value="" id="alaycare-client-id">
            ...
            <div class="modal-footer border-top-0 bg-light">
                <div class="d-flex justify-content-end align-items-center w-100">
                    ...
                    <span class="spinner-border spinner-border-sm d-none" id="create-alayacare-client" aria-hidden="true"></span>
