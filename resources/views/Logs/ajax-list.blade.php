    ...
    <table id="order-listing1" class="table table-bordered table-head-fix recordtabletdwidth">
            ...
            <tr>
                ...
                <th>
                    <div class="sorting-div"><span>Type</span>
                        <div class="sorting-btn">
                            <button type="button" class="record_id" data-field="type" data-sort="asc"><i class="fa fa-sort-up"></i> </button><button type="button" class="record_id" data-field="type" data-sort="desc"><i class="fa fa-sort-down"></i>
                            </button>
                        </div>
                    </div>
                </th>
                ...
                <th>
                    <div class="sorting-div"><span>Module</span>
                        <div class="sorting-btn">
                            <button type="button" class="record_id" data-field="module" data-sort="asc"><i class="fa fa-sort-up"></i> </button><button type="button" class="record_id" data-field="module" data-sort="desc"><i class="fa fa-sort-down"></i>
                            </button>
                        </div>
                    </div>
                </th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="white-space:nowrap"><a target="_blank" href="{{$row->link}}">{{$i++}}</a></td>

                <td style="min-width:220px; white-space:nowrap" data-sort="">
                    <a href="{{URL::to('/')}}/user-view/{{$row->created_by}}">{{ ucfirst($row->username) }}</a>
                </td>
                <td style="min-width:220px; white-space:nowrap">
                    {{$row->ip}}
                </td>
