    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="row list-name">
                <div class="col-sm-5">
                    <h4 class="card-title">Log List (<span id="total_record"></span>)</h4>
                </div>
        ...
        <script>
            var userLogList = "{{ route('all-log-list') }}";
        ...
        <script type="text/javascript" src="{{ URL::to('/') }}/js/user-log.js"></script>