...
<div class="container-fluid">
    <div class="content-wrapper">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Create New Role</h5>
        </div>
        <div class="row">
            <div class="col-md-12">
                <!-- DataTales Example -->
                                ...
                                <div class="card-body  pl-0">
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control form-control-user col-sm-11"
                                            id="name" name="name" maxlength="25" aria-describedby="nameHelp"
                                            ...
                                            <table class="table table-bordered table-gray " width="100%"
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                            ...
                                                            @for ($i = 0; $i < 39; $i++)
                                                                ...
                                                                @endif
                                                                    <td class="row_td" style="white-space: nowrap;" colspan="{{$checkCount==$i ? (13-ceil($divideVal)):''}}">
                                                                        ...
                                                                        <input type="checkbox" class="form-check-input checkinput" name="permission[]" type="checkbox" id="permission" value="{{ isset($role['value'][$i]->id) ? $role['value'][$i]->id : '' }}">
                                                        ...
                                                        @php $i++; @endphp
                                                    @endforeach
                                                    <span class="col-sm-11" style="color:red" id="permission_error">
                                                        @error('permission')
                                                            {{ $message }}
                                                        @enderror
                                                    </span>
