...
<div class="main-panel main-page-box">
    ...
    <div class="content-wrapper content-wrapper-box">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Hub Record Report(<span id="total_record_id"></span>)</h5>
                            ...
                            <form id="search-form">
                                 ...
                                 <div class="col-md-3">
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-12">
                                             <input type="text" name="dob" readonly class="form-control" placeholder="Select Date of Birth" id="dob" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="mm/dd/yyyy" im-insert="false" value="">
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="col-md-3">
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-12">
                                             <input autocomplete="off" type="text" class="form-control" name="ssn" id="ssn" value="">
                                         </div>
                                     </div>
                                 </div>
                                 @endif
...
<script>
    var _HUB_RECORD_LIST ="{{ url('hub-record-report/ajax-list')}}";
    var _HUB_RECORD_CSV ="{{ url('hub-record-report/export-csv')}}";
...
<script src="{{ asset('assets/vendors/select2/select2.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/modulejs/hubRecordReport/hubRecordReport.js')}}?time={{ env('timestamp')}}"></script>