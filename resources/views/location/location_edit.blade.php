...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Location Edit</h5>
        </div>
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form class="form-sample" method="post" action='<?php echo URL::to('/location/update'); ?>/<?php echo $id; ?>'
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="telehealth_config" id="telehealth_config" class="form-control">
                                                ...
                                                <option value="caregiver" @if($agency->telehealth_config == 'caregiver') selected @endif>Caregiver</option>
                                                <option value="patient" @if($agency->telehealth_config == 'patient') selected @endif>Patient</option>
                                            </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="mm/dd/yyyy" class="form-control bill_date form-control-sm " autocomplete="off" placeholder="Select Stop Date" id="stop_date" name="stop_date" value="{{ $agency->stop_date ? date('m/d/Y', strtotime($agency->stop_date)) : '' }}" min="1000-01-01" max="9999-12-31">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control time_input form-control-sm"
                                                ...
                                                id="stop_time"
                                                name="stop_time"
                                                value="{{ $agency->stop_time ? date('H:i', strtotime($agency->stop_time)) : '' }}"
