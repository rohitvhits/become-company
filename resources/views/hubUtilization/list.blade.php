...
<link rel="stylesheet" href="{{ asset('/assets/modulejs/css/hub_record/hubUtilization.css')}}">
...
<div class="main-panel main-page-box">
    ...
    <div class="content-wrapper content-wrapper-box">
        ...
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Hub Utilization(<span id="total_record_id"></span>)</h5>
            <div class="page-rightbtns cust-page-rightbtns">
                <div>
                    
                    @can('hub-utilization-report-import')        
                        <a href="javascript:void(0)" data-toggle="modal" class="btn btn-secondary btn-sm btn-fw cust-right-btn" data-target="#import-modal" data-whatever="@mdo" onclick="openImportModal();"><i class="mdi mdi-file-export"></i>Import</a>
                    @endcan
        ...
        <div class="page-title-main mt-2">
            ...
            <div class="page-rightbtns cust-page-rightbtns">
                <div>
                    <a href="javascript:void(0)" class="btn btn-info btn-sm btn-fw cust-right-btn" onclick="loadImport()"><i class="mdi mdi-history"></i>Show Import Logs</a>
                </div>
            </div>
        </div> 
        @endcan
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center form-patient-list-box">
                            ...
                            <div class="row form-row-gap">
                                <div class="col-md-3">
                                    <input type="text" class="form-control" id="file-name" placeholder="Search by file name">
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    <div class="appointment-btn-box" style="justify-content:left !important">
                                        <input type="button" name="search" class="btn search-btn1 searchAppoinment" id="search-data" value="Search" onclick="searchImport(1)">
                                        <a href="javascript:void(0)" class="btn btn-light btn-rounded btn-fw btn-sm" onclick="refreshImport()"><i class="mdi mdi-reload"></i> Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-0">
                        <div id="import-list" class="table-responsive">
                        </div>
                    </div>
                </div>
            </div>
...
@include('hubUtilization/modal/hub_uitlization_import_record')
 <script src="<?php echo URL::to('/'); ?>/assets/js/jquery.tokeninput.js"></script>
<script>
    var RECORD_LIST ="{{ url('hub-uitlization/ajax-list')}}";
    var _DATE_TIME = "{{ date('m/d/Y')}}";
    var _GET_COUNTRY_CODE  ="{{ url('get-county')}}";
    var _CSRF_TOKEN = '{{ csrf_token() }}';
    var HUB_RECORD_CSV = "{{ url('hub-uitlization/csv-list') }}";
    var urlToken = "{{ url('search-nybest-user') }}";
    var IMPORT_DATA = "{{url('import-hub-uitlization')}}";
    var IMPORT_LOGS_URL = "{{url('hub-uitlization/import-logs')}}";
    ...
    function displayImport(logs) {
        const container = $('#import-list');
        container.empty();
        container.html(logs);
    }
...
<script type="text/javascript" src="{{ asset('assets/modulejs/hubUtilization/hubUtilization.js')}}?time={{ env('timestamp')}}"></script>
