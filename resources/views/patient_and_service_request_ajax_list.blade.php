 ...
 <?php
                                                ...
                                                <?php
                                                if ($row->status == 'cancelled' or $row->status == 'refuese' or $row->status == 'no show' or  $row->status == 'no answer' or $row->status == 'unable to contact') {
                                                ?>
                                                ...
                                                <?php }
                                                if ($row->status == 'hospitalized/rehab' || $row->status == 'hospitalized') { ?>
...
<?php } ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row->patient->due_date != '1969-12-31') {
