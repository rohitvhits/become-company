    ...
    <div class="content-wrapper content-wrapper-box">
     ...
     @endcan     
        <div class="page-title-main">
            <h5 class="mb-0 font-weight-bold">Referrals Analytics Dashboard Report</h5>
                                ...
                                <div class="col-md-9">
                                    <div class="appointment-btn-box" style="justify-content:left !important">
                                        <input type="button" name="search"
                                            ...
                                            value="Search" onclick="dashboardList(1)">
...
<script>
    var _LIST ="{{ url('referrals-analytics-ajax')}}";
...
<script src="{{ asset('assets/vendors/select2/select2.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/modulejs/referralsAnalyticsDashboard/referralsAnalyticsDashboard.js')}}?time={{ env('timestamp')}}"></script>