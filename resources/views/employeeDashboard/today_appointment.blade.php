        ...
        @if (count($todayAppoinmentData) > 0)
            ...
            <tr>
                ...
                <?php
                    ...
                    @if ($todayData->status == 'Patient Deceased' || $todayData->status == 'Appointment was missed' || $todayData->status == 'Closed Temporarily')
                        <label for="" class='badge badge-danger'>{{$todayData->status}}</label>
                    @endif

                    @if ($todayData->status == 'Signed' || $todayData->status == 'Signed & Sent Back to the Agency'|| $todayData->status == 'New Order Received')
