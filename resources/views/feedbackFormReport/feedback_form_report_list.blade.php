 ...
 <div class="main-panel">
     <div class="content-wrapper">
         <div class="page-title-main">
             <h5 class="mb-0 font-weight-bold">Feedback Form Report</h5>
         </div>
                                 ...
                                 <div class="search-inner">
                                     <div>
                                         <input type="button" name="search"
                                             class="btn btn-primary search-btn1 searchAppoinment" onclick="loadReportList(1);" id="search-data"
                                             value="Search">
                                             <a href="<?php echo URL::to('/'); ?>/feedback-form-report" class="btn btn-light btn-rounded btn-fw btn-sm ml-1"><i
...
@include('feedbackFormReport/_partial/log_modal')
...
<script>
    var FEEDBACK_FORM_LIST = "{{ url('feedback-form-report-ajax-list') }}";
    var FEEDBACK_FORM = '{{ url("/feedback-form-report") }}'; 
    var FEEDBACK_FORM_BY_ID = '{{ url("/get-feedback-form-by-id") }}'; 
</script>
<script src="{{ asset('assets/modulejs/feedbackFormReport/feedback_form_report.js')}}?time={{ time()}}"></script>
