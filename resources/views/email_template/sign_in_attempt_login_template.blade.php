                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 15px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        A sign in attempt requiring further verification just occurred. To complete the sign in, enter the following verification code to gain access to the system.
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                    Note: The verification code expires in the next {{$duration}}.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
