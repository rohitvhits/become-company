                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 20px 0 29px 0; color: #00BBE0 !important; font-family: Arial, sans-serif; font-size: 20px; line-height: 20px;">
                                        <b> Caregiver status has been updated to No Show</b>
                                    </td>
                                </tr>
                                @elseif($status == "checkin")
                                <tr>
                                    <td style="padding: 20px 0 29px 0; color: #00BBE0 !important; font-family: Arial, sans-serif; font-size: 20px; line-height: 20px;">
                                        <b> {{$type}} has arrived to appointment and results are pending</b>
                                    </td>
                                </tr>
                                @else
                                <tr>
                                    <td style="padding: 20px 0 29px 0; color: #00BBE0 !important; font-family: Arial, sans-serif; font-size: 20px; line-height: 20px;">
                                        <b> {{$type}} status has been updated to {{$status}} </b>
                                    </td>
                                </tr>
                                @endif
                                <tr>
