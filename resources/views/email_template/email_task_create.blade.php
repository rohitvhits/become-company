                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="font-family: Arial, sans-serif; font-size: 20px; line-height: 20px;">
                                ...
                                <tr>
                                    <td style="padding: 20px 0 29px 0; color: #00BBE0 !important; font-family: Arial, sans-serif; font-size: 20px; line-height: 20px;">
                                        <b> Below new task is assigned to you.</b>
                                    </td>
                                </tr>

                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Added By:</b> {{$username}} </a>
                                    </td>
                                </tr>

                                <tr>
                                    <td style="padding: 15px 0 15px 0; color: #00BBE0 !important; font-family: Arial, sans-serif; font-size: 14px; line-height: 10px;">
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Task Name:</b> {{$task_name}}
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Task Description :</b> {{$task_description}} </a>
                                    </td>
                                </tr>  
