                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Task Id:</b> <a target="_blank" href="{{url('tasks/task-list')}}/{{$task_id}}"> {{$task_id}} </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Task Status :</b> {{$taskStatus}}
                                    </td>
                                </tr> 

                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Task Due Date :</b> {{$due_date}}
                                    </td>
                                </tr> 
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 13px; line-height: 20px;">
                                        <b>Patient Email :</b> {{$patient_email}}
                                    </td>
                                </tr> 
