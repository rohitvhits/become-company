    ...
    <div class="modal-dialog modal-lg-plus">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Update Popup</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>

            <form action="<?php echo URL::to('/event-master/'); ?>" method="post" id="eventEdit" name="eventEdit" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="content" class="form-control" id="event_edit_content" value="{{ old('content') }}">{{ old('content') }}</textarea>
