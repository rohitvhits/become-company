    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" enctype="multipart/form-data" action="<?php echo URL::to('/patient/appointment-add'); ?>" name="adduser"
                    method="post" id="form">
                    ...
                    <div class="form-group setDate">
                        ...
                        <input readonly type="text" name="date" class="form-control getappoinmentdate"
                            autocomplete="off" id="date_id" onchange="getTimeSearch()" value="<?php echo $dates; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <?php } else { ?>
                        <input type="time" name="time" class="form-control" id="times_id"
                            value="<?php echo $time; ?>">
                        <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-multiple w-100 new_service_id" multiple="multiple"
                                ...
                                @if (count($locations) > 0)
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}"
                                            {{ $record->location_id == $location->id ? 'selected' : '' }}>
