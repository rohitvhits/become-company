<div class="modal fade " id="exampleModal-upload-document" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Add Upload Document</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="closed_id_upload_document">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="" method="POST" id="edit_upload_document_modal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <span id="document_name_error" class="error mt-2" for="document_name"></span>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Upload Document<span
                                class="error">*</span>:</label>
                        <input type="file" class="form-control" id="file_upload" name="file_upload">
                        <span class="error mt-2" id="file_upload_error" for="file_name"></span>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" id="edit_upload_document_modal_submit">Save</button>
                </div>
            </form>
        </div>
    </div>
