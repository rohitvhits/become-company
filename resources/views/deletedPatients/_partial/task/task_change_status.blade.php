        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms-sample" enctype="multipart/form-data" action="{{url('tasks/task-change-status')}}" name="adduser" method="post" id="form-changes-status">
                        ...
                        <input type="hidden" name="recordId" id="recordId" value="{{Request()->id}}">
                            <div class="form-group">
                                ...
                                <span id="location_error" class="error mt-2" for="document_type"></span>
                            </div>
                            <div class="form-group">
